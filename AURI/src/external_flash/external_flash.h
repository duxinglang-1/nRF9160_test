...
#define IMG_BIG_NUM_0_END 	(IMG_NO_COLON_ADDR+IMG_NO_COLON_SIZE)
...
//AUDIO在flash里占用2M的空间(0x600000~0x7FFFFF)
#define AUDIO_START_ADDR		0x600000
#define AUDIO_OFFSET			4

#define AUDIO_FALL_ALARM_ADDR 	AUDIO_START_ADDR
#define AUDIO_FALL_ALARM_SIZE 	(276612)
#define AUDIO_FALL_ALARM_END 	(AUDIO_FALL_ALARM_ADDR+AUDIO_FALL_ALARM_SIZE)

#define AUDIO_END_ADDR			0x7FFFFF
