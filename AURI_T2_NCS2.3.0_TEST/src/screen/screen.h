...
#define PWR_OFF_KEY_CN_X	((LCD_WIDTH-PWR_OFF_KEY_CN_W)/2)
#define PWR_OFF_KEY_CN_Y	PWR_OFF_ICON_H

#define PWR_OFF_KEY_EN_W	96
#define PWR_OFF_KEY_EN_H	32
#define PWR_OFF_KEY_EN_X	((LCD_WIDTH-PWR_OFF_KEY_EN_W)/2)
#define PWR_OFF_KEY_EN_Y	PWR_OFF_ICON_H
...
typedef struct
{
	...
	uint8_t *img;
	uint32_t img_addr;
	uint8_t text[NOTIFY_TEXT_MAX_LEN+1];
}notify_infor;
...
extern void DisplayPopUp(uint8_t *message);
