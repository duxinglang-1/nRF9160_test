...
#define FOTA_NOTIFY_RECT_W		LCD_WIDTH
#define FOTA_NOTIFY_RECT_H		LCD_HEIGHT
#define FOTA_NOTIFY_RECT_X		((LCD_WIDTH-FOTA_NOTIFY_RECT_W)/2)
#define FOTA_NOTIFY_RECT_Y		((LCD_HEIGHT-FOTA_NOTIFY_RECT_H)/2)

#define FOTA_NOTIFY_STRING_W	(LCD_WIDTH)
#define	FOTA_NOTIFY_STRING_H	(LCD_HEIGHT)
#define	FOTA_NOTIFY_STRING_X	0
#define	FOTA_NOTIFY_STRING_Y	0

#define FOTA_NOTIFY_PRO_W		(FOTA_NOTIFY_RECT_W-20)
#define FOTA_NOTIFY_PRO_H		16
#define FOTA_NOTIFY_PRO_X		(FOTA_NOTIFY_RECT_X+(FOTA_NOTIFY_RECT_W-FOTA_NOTIFY_PRO_W)/2)
#define FOTA_NOTIFY_PRO_Y		(FOTA_NOTIFY_STRING_Y+16)
