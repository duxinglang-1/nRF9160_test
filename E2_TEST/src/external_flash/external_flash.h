...
#define IMG_SEDENTARY_LOGO_ADDR				(IMG_RUNNING_ANI_4_END+IMG_OFFSET)
...
//temperature(4)
#define IMG_TEMP_ICON_C_ADDR				(IMG_SYNC_STR_END+IMG_OFFSET)
#define IMG_TEMP_ICON_C_SIZE				(19588)
...
#define IMG_TEMP_ICON_F_SIZE				(19588)
