...
#define IMG_BP_UP_ARRAW_ADDR				(IMG_BP_BG_END+IMG_OFFSET)
#define IMG_BP_UP_ARRAW_SIZE				(586)
#define IMG_BP_UP_ARRAW_END					(IMG_BP_UP_ARRAW_ADDR+IMG_BP_UP_ARRAW_SIZE)
#define IMG_BP_DOWN_ARRAW_ADDR				(IMG_BP_UP_ARRAW_END+IMG_OFFSET)
#define IMG_BP_DOWN_ARRAW_SIZE				(392)
#define	IMG_BP_DOWN_ARRAW_END				(IMG_BP_DOWN_ARRAW_ADDR+IMG_BP_DOWN_ARRAW_SIZE)
#define	IMG_BP_DOWN_LINE_ADDR				(IMG_BP_DOWN_ARRAW_END+IMG_OFFSET)
#define IMG_BP_DOWN_LINE_SIZE				(64)
#define IMG_BP_DOWN_LINE_END				(IMG_BP_DOWN_LINE_ADDR+IMG_BP_DOWN_LINE_SIZE)
#define IMG_BP_MEASUREING_ADDR				(IMG_BP_DOWN_LINE_END+IMG_OFFSET)
#define IMG_BP_MEASUREING_SIZE				(6520)
#define IMG_BP_MEASUREING_END				(IMG_BP_MEASUREING_ADDR+IMG_BP_MEASUREING_SIZE)
#define IMG_BP_MEASURENING_ANI_1_ADDR		(IMG_BP_MEASUREING_END+IMG_OFFSET)
#define	IMG_BP_MEASURENING_ANI_1_SIZE		(42596)
#define IMG_BP_MEASURENING_ANI_1_END		(IMG_BP_MEASURENING_ANI_1_ADDR+IMG_BP_MEASURENING_ANI_1_SIZE)
#define IMG_BP_MEASURENING_ANI_2_ADDR		(IMG_BP_MEASURENING_ANI_1_END+IMG_OFFSET)
#define IMG_BP_MEASURENING_ANI_2_SIZE		(42596)
#define IMG_BP_MEASURENING_ANI_2_END		(IMG_BP_MEASURENING_ANI_2_ADDR+IMG_BP_MEASURENING_ANI_2_SIZE)
#define	IMG_BP_MEASURENING_ANI_3_ADDR		(IMG_BP_MEASURENING_ANI_2_END+IMG_OFFSET)
#define IMG_BP_MEASURENING_ANI_3_SIZE		(42596)
#define IMG_BP_MEASURENING_ANI_3_END		(IMG_BP_MEASURENING_ANI_3_ADDR+IMG_BP_MEASURENING_ANI_3_SIZE)
#define	IMG_BP_MMHG_ADDR					(IMG_BP_MEASURENING_ANI_3_END+IMG_OFFSET)
#define IMG_BP_MMHG_SIZE					(1044)
#define IMG_BP_MMHG_END						(IMG_BP_MMHG_ADDR+IMG_BP_MMHG_SIZE)
#define IMG_BP_TIME_DOT_ADDR				(IMG_BP_MMHG_END+IMG_OFFSET)
#define	IMG_BP_TIME_DOT_SIZE				(28)
#define	IMG_BP_TIME_DOT_END					(IMG_BP_TIME_DOT_ADDR+IMG_BP_TIME_DOT_SIZE)
//heart rate
#define IMG_HR_BG_ADDR						(IMG_BP_TIME_DOT_END+IMG_OFFSET)
#define IMG_HR_BG_SIZE						(35440)
#define IMG_HR_BG_END						(IMG_HR_BG_ADDR+IMG_HR_BG_SIZE)
#define IMG_HR_BPM_BIG_ADDR					(IMG_HR_BG_END+IMG_OFFSET)
#define IMG_HR_BPM_BIG_SIZE					(1988)
#define IMG_HR_BPM_BIG_END					(IMG_HR_BPM_BIG_ADDR+IMG_HR_BPM_BIG_SIZE)
#define IMG_HR_BPM_MID_ADDR					(IMG_HR_BPM_BIG_END+IMG_OFFSET)
#define IMG_HR_BPM_MID_SIZE					(1232)
#define IMG_HR_BPM_MID_END					(IMG_HR_BPM_MID_ADDR+IMG_HR_BPM_MID_SIZE)
#define IMG_HR_BPM_SMALL_ADDR				(IMG_HR_BPM_MID_END+IMG_OFFSET)
#define IMG_HR_BPM_SMALL_SIZE				(764)
#define IMG_HR_BPM_SMALL_END				(IMG_HR_BPM_SMALL_ADDR+IMG_HR_BPM_SMALL_SIZE)
#define IMG_HR_DOWN_ARRAW_ADDR				(IMG_HR_BPM_SMALL_END+IMG_OFFSET)
#define IMG_HR_DOWN_ARRAW_SIZE				(548)
#define IMG_HR_DOWN_ARRAW_END				(IMG_HR_DOWN_ARRAW_ADDR+IMG_HR_DOWN_ARRAW_SIZE)
#define IMG_HR_DOWN_LINE_ADDR				(IMG_HR_DOWN_ARRAW_END+IMG_OFFSET)
#define IMG_HR_DOWN_LINE_SIZE				(80)
#define IMG_HR_DOWN_LINE_END				(IMG_HR_DOWN_LINE_ADDR+IMG_HR_DOWN_LINE_SIZE)
#define IMG_HR_ICON_ADDR					(IMG_HR_DOWN_LINE_END+IMG_OFFSET)
#define IMG_HR_ICON_SIZE					(2116)
#define	IMG_HR_ICON_END						(IMG_HR_ICON_ADDR+IMG_HR_ICON_SIZE)
#define	IMG_HR_MEASURING_ADDR				(IMG_HR_ICON_END+IMG_OFFSET)
#define IMG_HR_MEASURING_SIZE				(2816)
#define	IMG_HR_MEASURING_END				(IMG_HR_MEASURING_ADDR+IMG_HR_MEASURING_SIZE)
#define IMG_HR_STATIC_ADDR					(IMG_HR_MEASURING_END+IMG_OFFSET)
#define IMG_HR_STATIC_SIZE					(2340)
#define IMG_HR_STATIC_END					(IMG_HR_STATIC_ADDR+IMG_HR_STATIC_SIZE)
#define	IMG_HR_TIME_DOT_ADDR				(IMG_HR_STATIC_END+IMG_OFFSET)
...
//ota
#define IMG_OTA_DOWNLOADING_ADDR			(IMG_IDLE_STEP_LOGO_END+IMG_OFFSET)
...
#define IMG_PWROFF_LOGO_ADDR				(IMG_PWROFF_BUTTON_END+IMG_OFFSET)
#define IMG_PWROFF_LOGO_SIZE				(1508)
#define IMG_PWROFF_LOGO_END					(IMG_PWROFF_LOGO_ADDR+IMG_PWROFF_LOGO_SIZE)
#define IMG_PWROFF_NO_ADDR					(IMG_PWROFF_LOGO_END+IMG_OFFSET)
...
//step
#define IMG_STEP_ANI_1_ADDR					(IMG_SLEEP_MIN_END+IMG_OFFSET)
...
//wrist off
#define IMG_WRIST_OFF_ICON_ADDR				(IMG_SYNC_STR_END+IMG_OFFSET)
