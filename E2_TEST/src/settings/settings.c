...
u8_t g_fw_version[64] = "V1.6.0_20220402";
...
const settings_menu_t SETTING_MAIN_MENU = 
{
	...
	8,
	{
		...
		},
		{
			...
			{0x004f,0x0054,0x0041,0x0020,0x0055,0x0070,0x0064,0x0061,0x0074,0x0065,0x0000},//OTA Update
			{0x0048,0x0065,0x006C,0x006C,0x0049,0x0067,0x006B,0x0065,0x0049,0x0074,0x0000},//Helligkeit
			{0x0054,0x0065,0x006D,0x0070,0x0020,0x0041,0x006E,0x007A,0x0065,0x0049,0x0067,0x0065,0x0000},//Temp Anzeige
	...
	{
		{
			...
			{0x0045,0x006E,0x0067,0x006C,0x0049,0x0073,0x0068,0x0000},//English
...
const settings_menu_t SETTING_MENU_TEMP = 
{
	...
	2,
	{
		...
		{
			{0x0043,0x0065,0x006C,0x0073,0x0049,0x0075,0x0073,0x0000},//Celsius
			{0x0046,0x0061,0x0068,0x0072,0x0065,0x006E,0x0068,0x0065,0x0049,0x0074,0x0000},//Fahrenheit
		},
		{
			{0x0043,0x0065,0x006C,0x0073,0x0049,0x0075,0x0073,0x0000},//Celsius
			{0x0046,0x0061,0x0068,0x0072,0x0065,0x006E,0x0068,0x0065,0x0049,0x0074,0x0000},//Fahrenheit
