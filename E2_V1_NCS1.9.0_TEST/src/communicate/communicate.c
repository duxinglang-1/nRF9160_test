...
/*void location_get_gps_data_reply(bool flag, struct gps_pvt gps_data)
{
	...
	tmp1 = (uint32_t)(gps_data.latitude);	//锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
	tmp2 = gps_data.latitude - tmp1;	//锟斤拷锟斤拷小锟斤拷锟斤拷锟斤拷
	//integer
	...
	tmp1 = (uint32_t)(gps_data.longitude);	//锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
	tmp2 = gps_data.longitude - tmp1;	//锟斤拷锟斤拷小锟斤拷锟斤拷锟斤拷
	//integer
	sprintf(tmpbuf, "%d", tmp1);
	strcat(reply, tmpbuf);
	//dot
