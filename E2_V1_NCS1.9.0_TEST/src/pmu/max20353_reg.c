...
int MAX20353_LDO1Config(void)
{
    ...
    appdatainoutbuffer_[0] = 0x05;     //0x01  0.5V to 1.95V, Linear Scale, 25mV increments,ʹ��   LDO1  
...
int MAX20353_LDO1Disable(void)
{
    ...
    appcmdoutvalue_ = 0x40;
    appdatainoutbuffer_[0] = 0x04;     //0x01  0.5V to 1.95V, Linear Scale, 25mV increments,ʹ��   LDO1  
    appdatainoutbuffer_[1] = 0x34;     //0x28  0.5V + (0.025V * number)   =  1.95V   1.8
    ret = MAX20353_AppWrite(2);
...
bool MAX20353_Init(void)
{
	...
	MAX20353_LDO2Config();		//3.3V 100mA ��CTP����
	MAX20353_BoostConfig();		//5V   ֻ��buck2��3.3V�رգ���PPG�Ż���

	//��ɱü�BUCK/BOOST����
	//MAX20353_ChargePumpConfig();
	MAX20353_BuckBoostConfig();	//4.0V �����⹩��

	//��������
#ifdef MOTOR_TYPE_ERM
	MAX20303_HapticConfigDCMotor();
#elif defined(MOTOR_TYPE_LRA)
	MAX20353_HapticConfig();	//�������������������г�ʼ��  
	//MAX20353_InitRAM();  		//������ģʽ
#endif
...
#ifdef BATTERY_SOC_GAUGE	//xb add 2020-11-05 �����йص����ƵĴ���
//******************************************************************************
int ReadWord(uint8_t reg, uint8_t *MSB, uint8_t *LSB)
{
	uint32_t ret;
...
void MAX20353_UpdateTemper(void)
{
	...
	static uint16_t pre_temper=25;	//��ʼ��Ĭ��25��
