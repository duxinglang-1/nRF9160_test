...
void tp_interrupt_proc(void)
{
	...
	platform_read(TP_REG_GESTURE, &tp_temp[0], 1);//����
	platform_read(TP_REG_FINGER_NUM, &tp_temp[1], 1);//��ָ����
	platform_read(TP_REG_XPOS_H, &tp_temp[2], 1);//x������(&0x0f,ȡ��4λ)
	platform_read(TP_REG_XPOS_L, &tp_temp[3], 1);//x������
	platform_read(TP_REG_YPOS_H, &tp_temp[4], 1);//y������(&0x0f,ȡ��4λ)
	platform_read(TP_REG_YPOS_L, &tp_temp[5], 1);//y������
