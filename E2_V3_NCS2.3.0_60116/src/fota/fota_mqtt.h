...
#define FOTA_RUNNING_STR_W		164
#define FOTA_RUNNING_STR_H		23
#define FOTA_RUNNING_STR_X		((LCD_WIDTH-FOTA_RUNNING_STR_W)/2)
#define FOTA_RUNNING_STR_Y		95
...
#define FOTA_FINISH_ICON_W		90
#define FOTA_FINISH_ICON_H		90
#define FOTA_FINISH_ICON_X		((LCD_WIDTH-FOTA_FINISH_ICON_W)/2)
#define FOTA_FINISH_ICON_Y		40
#define FOTA_FINISH_STR_W		182
#define FOTA_FINISH_STR_H		23
#define FOTA_FINISH_STR_X		((LCD_WIDTH-FOTA_FINISH_STR_W)/2)
#define FOTA_FINISH_STR_Y		165
#define FOTA_FAIL_ICON_W		90
#define FOTA_FAIL_ICON_H		90
#define FOTA_FAIL_ICON_X		((LCD_WIDTH-FOTA_FAIL_ICON_W)/2)
#define FOTA_FAIL_ICON_Y		40
#define FOTA_FAIL_STR_W			136
#define FOTA_FAIL_STR_H			23
#define FOTA_FAIL_STR_X			((LCD_WIDTH-FOTA_FAIL_STR_W)/2)
#define FOTA_FAIL_STR_Y			165
