...
static void SettingsMenuStep1Proc(void);
static void SettingsMenuStep2Proc(void);
static void SettingsMenuSleep1Proc(void);
static void SettingsMenuSleep2Proc(void);
...
const settings_menu_t SETTING_MENU_STEP = 
{
	SETTINGS_MENU_STEP,
	0,
	2,
	...
	{
		SettingsMenuStep1Proc,
		SettingsMenuStep2Proc,
	},
	{	
		//page proc func
		SettingsMenuDumpProc,
...
const settings_menu_t SETTING_MENU_SLEEP = 
{
	SETTINGS_MENU_SLEEP,
	0,
	2,
	...
	{
		SettingsMenuSleep1Proc,
		SettingsMenuSleep2Proc,
	},
	{	
		//page proc func
		SettingsMenuDumpProc,
...
void SettingsMenuStep1Proc(void)
{
	if(global_settings.step_is_on != false)
	{
...
void SettingsMenuStep2Proc(void)
{
	if(global_settings.step_is_on != true)
	{
...
void SettingsMenuSleep1Proc(void)
{
	if(global_settings.sleep_is_on != false)
	{
...
void SettingsMenuSleep2Proc(void)
{
	if(global_settings.sleep_is_on != true)
	{
