...
const settings_menu_t SETTING_MAIN_MENU = 
{
	...
	7,
	{
		...
		},
		{
			...
			{0x0043,0x0061,0x0072,0x0065,0x006D,0x0061,0x0074,0x0065,0x0020,0x0051,0x0052,0x0000},////Caremate QR
			{0x0044,0x00E9,0x0066,0x0061,0x0075,0x0074,0x0020,0x0064,0x0065,0x0020,0x0066,0x0061,0x0062,0x0072,0x0069,0x0063,0x0061,0x0074,0x0069,0x006F,0x006E,0x0000},//Défaut de fabrication
