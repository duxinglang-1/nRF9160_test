...
void EnterFactoryTestResults(void)
{
	...
	uint16_t str_notify[LANGUAGE_MAX][35] = {
												...
												{0x0049,0x006C,0x0020,0x0065,0x0073,0x0074,0x0020,0x0065,0x006E,0x0020,0x0063,0x006F,0x0075,0x0072,0x0073,0x0020,0x0064,0x0065,0x0020,0x0064,0x00E9,0x0076,0x0065,0x006C,0x006F,0x0070,0x0070,0x0065,0x006D,0x0065,0x006E,0x0074,0x002E,0x0000},//Il est en cours de d®¶veloppement.
											  #endif
												...
												{0x0053,0x0065,0x0020,0x0065,0x0073,0x0074,0x00E1,0x0020,0x0064,0x0065,0x0073,0x0061,0x0072,0x0072,0x006F,0x006C,0x006C,0x0061,0x006E,0x0064,0x006F,0x002E,0x0000},//Se est®¢ desarrollando.
											  #endif
											  #ifdef LANGUAGE_PT_ENABLE
												{0x0045,0x0073,0x0074,0x00E1,0x0020,0x0073,0x0065,0x006E,0x0064,0x006F,0x0020,0x0064,0x0065,0x0073,0x0065,0x006E,0x0076,0x006F,0x006C,0x0076,0x0069,0x0064,0x006F,0x002E,0x0000},//Est®¢ sendo desenvolvido.
											  #endif
											  	...
											  	{0x3053,0x306E,0x6A5F,0x80FD,0x306F,0x958B,0x767A,0x4E2D,0x3067,0x3059,0x3002,0x0000},//§≥§ŒôCƒ‹§œÈ_∞k÷–§«§π°£
											  #endif
											  	...
											  	{0x042D,0x0442,0x0430,0x0020,0x0444,0x0443,0x043D,0x043A,0x0446,0x0438,0x044F,0x0020,0x0432,0x0020,0x0440,0x0430,0x0437,0x0440,0x0430,0x0431,0x043E,0x0442,0x043A,0x0435,0x002E,0x0000},//ßøß‰ß— ßÊßÂßﬂß‹ßËß⁄ßÒ ß” ß‚ß—ßŸß‚ß—ß“ß‡ß‰ß‹ß÷.
											  #endif
												...
												{0x6B64,0x529F,0x80FD,0x6B63,0x5728,0x5F00,0x53D1,0x3002,0x0000},//¥Àπ¶ƒ‹’˝‘⁄ø™∑¢°£
											  #endif
											  #ifdef LANGUAGE_EN_ENABLE
												{0x0049,0x0074,0x0020,0x0069,0x0073,0x0020,0x0062,0x0065,0x0069,0x006E,0x0067,0x0020,0x0064,0x0065,0x0076,0x0065,0x006C,0x006F,0x0070,0x0065,0x0064,0x002E,0x0000},//It is being developed.
											  #endif
