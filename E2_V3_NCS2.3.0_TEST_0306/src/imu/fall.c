...
void FallRecLocatNotify(uint8_t *strmsg)
{
	uint16_t strtitle[LANGUAGE_MAX][2][40] = {
												...
												{
													//「XXXXXXXXXXXXXXX」付近の落下場所がCareMateに投稿されました。
													{0x300C,0x0000},
												...
												{
													//Место падения около "XXXXXXXXXXXXXXX" опубликовано в CareMate.
												...
												},
												{
													...
													{0x0022,0x0020,0x0639,0x0644,0x0649,0x0043,0x0061,0x0072,0x0065,0x004D,0x0061,0x0074,0x0065,0x002E,0x0000},
												},
											#else
												{
