...
uint16_t ppg_timing_notify_en[] =
{
	//The timing measurement is about to start, and this measurement is end!
	0x0054,0x0068,0x0065,0x0020,0x0074,0x0069,0x006D,0x0069,0x006E,0x0067,0x0020,0x006D,0x0065,0x0061,0x0073,0x0075,
	0x0072,0x0065,0x006D,0x0065,0x006E,0x0074,0x0020,0x0069,0x0073,0x0020,0x0061,0x0062,0x006F,0x0075,0x0074,0x0020,
	0x0074,0x006F,0x0020,0x0073,0x0074,0x0061,0x0072,0x0074,0x002C,0x0020,0x0061,0x006E,0x0064,0x0020,0x0074,0x0068,
	0x0069,0x0073,0x0020,0x006D,0x0065,0x0061,0x0073,0x0075,0x0072,0x0065,0x006D,0x0065,0x006E,0x0074,0x0020,0x0069,
	0x0073,0x0020,0x0065,0x006E,0x0064,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_DE_ENABLE
uint16_t ppg_timing_notify_de[] =
{
	//Die Zeitmessung startet kurz vor dem Start und diese Messung ist vorbei!
	0x0044,0x0069,0x0065,0x0020,0x005A,0x0065,0x0069,0x0074,0x006D,0x0065,0x0073,0x0073,0x0075,0x006E,0x0067,0x0020,
	0x0073,0x0074,0x0061,0x0072,0x0074,0x0065,0x0074,0x0020,0x006B,0x0075,0x0072,0x007A,0x0020,0x0076,0x006F,0x0072,
	0x0020,0x0064,0x0065,0x006D,0x0020,0x0053,0x0074,0x0061,0x0072,0x0074,0x0020,0x0075,0x006E,0x0064,0x0020,0x0064,
	0x0069,0x0065,0x0073,0x0065,0x0020,0x004D,0x0065,0x0073,0x0073,0x0075,0x006E,0x0067,0x0020,0x0069,0x0073,0x0074,
	0x0020,0x0076,0x006F,0x0072,0x0062,0x0065,0x0069,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_FR_ENABLE
uint16_t ppg_timing_notify_fr[] =
{
	//La mesure de synchronisation est sur le point de commencer, et cette mesure est terminée!
	0x004C,0x0061,0x0020,0x006D,0x0065,0x0073,0x0075,0x0072,0x0065,0x0020,0x0064,0x0065,0x0020,0x0073,0x0079,0x006E,
	0x0063,0x0068,0x0072,0x006F,0x006E,0x0069,0x0073,0x0061,0x0074,0x0069,0x006F,0x006E,0x0020,0x0065,0x0073,0x0074,
	0x0020,0x0073,0x0075,0x0072,0x0020,0x006C,0x0065,0x0020,0x0070,0x006F,0x0069,0x006E,0x0074,0x0020,0x0064,0x0065,
	0x0020,0x0063,0x006F,0x006D,0x006D,0x0065,0x006E,0x0063,0x0065,0x0072,0x002C,0x0020,0x0065,0x0074,0x0020,0x0063,
	0x0065,0x0074,0x0074,0x0065,0x0020,0x006D,0x0065,0x0073,0x0075,0x0072,0x0065,0x0020,0x0065,0x0073,0x0074,0x0020,
	0x0074,0x0065,0x0072,0x006D,0x0069,0x006E,0x00E9,0x0065,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_IT_ENABLE
uint16_t ppg_timing_notify_it[] =
{
	//La misurazione dei tempi sta per iniziare e questa misurazione è finita!
	0x004C,0x0061,0x0020,0x006D,0x0069,0x0073,0x0075,0x0072,0x0061,0x007A,0x0069,0x006F,0x006E,0x0065,0x0020,0x0064,
	0x0065,0x0069,0x0020,0x0074,0x0065,0x006D,0x0070,0x0069,0x0020,0x0073,0x0074,0x0061,0x0020,0x0070,0x0065,0x0072,
	0x0020,0x0069,0x006E,0x0069,0x007A,0x0069,0x0061,0x0072,0x0065,0x0020,0x0065,0x0020,0x0071,0x0075,0x0065,0x0073,
	0x0074,0x0061,0x0020,0x006D,0x0069,0x0073,0x0075,0x0072,0x0061,0x007A,0x0069,0x006F,0x006E,0x0065,0x0020,0x00E8,
	0x0020,0x0066,0x0069,0x006E,0x0069,0x0074,0x0061,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_ES_ENABLE
uint16_t ppg_timing_notify_es[] =
{
	//La medición del tiempo está por comenzar y esta medición ha terminado!
	0x004C,0x0061,0x0020,0x006D,0x0065,0x0064,0x0069,0x0063,0x0069,0x00F3,0x006E,0x0020,0x0064,0x0065,0x006C,0x0020,
	0x0074,0x0069,0x0065,0x006D,0x0070,0x006F,0x0020,0x0065,0x0073,0x0074,0x00E1,0x0020,0x0070,0x006F,0x0072,0x0020,
	0x0063,0x006F,0x006D,0x0065,0x006E,0x007A,0x0061,0x0072,0x0020,0x0079,0x0020,0x0065,0x0073,0x0074,0x0061,0x0020,
	0x006D,0x0065,0x0064,0x0069,0x0063,0x0069,0x00F3,0x006E,0x0020,0x0068,0x0061,0x0020,0x0074,0x0065,0x0072,0x006D,
	0x0069,0x006E,0x0061,0x0064,0x006F,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_PT_ENABLE
uint16_t ppg_timing_notify_pt[] =
{
	//A medi??o do tempo está prestes a come?ar e esta medi??o já terminou!
	0x0041,0x0020,0x006D,0x0065,0x0064,0x0069,0x00E7,0x00E3,0x006F,0x0020,0x0064,0x006F,0x0020,0x0074,0x0065,0x006D,
	0x0070,0x006F,0x0020,0x0065,0x0073,0x0074,0x00E1,0x0020,0x0070,0x0072,0x0065,0x0073,0x0074,0x0065,0x0073,0x0020,
	0x0061,0x0020,0x0063,0x006F,0x006D,0x0065,0x00E7,0x0061,0x0072,0x0020,0x0065,0x0020,0x0065,0x0073,0x0074,0x0061,
	0x0020,0x006D,0x0065,0x0064,0x0069,0x00E7,0x00E3,0x006F,0x0020,0x006A,0x00E1,0x0020,0x0074,0x0065,0x0072,0x006D,
	0x0069,0x006E,0x006F,0x0075,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_PL_ENABLE
uint16_t ppg_timing_notify_pl[] =
{
	//Pomiar czasu ma si? zaraz rozpocz??, a ten pomiar jest zakończony!
	0x0050,0x006F,0x006D,0x0069,0x0061,0x0072,0x0020,0x0063,0x007A,0x0061,0x0073,0x0075,0x0020,0x006D,0x0061,0x0020,
	0x0073,0x0069,0x0119,0x0020,0x007A,0x0061,0x0072,0x0061,0x007A,0x0020,0x0072,0x006F,0x007A,0x0070,0x006F,0x0063,
	0x007A,0x0105,0x0107,0x002C,0x0020,0x0061,0x0020,0x0074,0x0065,0x006E,0x0020,0x0070,0x006F,0x006D,0x0069,0x0061,
	0x0072,0x0020,0x006A,0x0065,0x0073,0x0074,0x0020,0x007A,0x0061,0x006B,0x006F,0x0144,0x0063,0x007A,0x006F,0x006E,
	0x0079,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_SE_ENABLE
uint16_t ppg_timing_notify_se[] =
{
	//Den tidsbest?mda m?tningen ?r p? v?g att starta, och denna m?tning ?r slutf?rd!
	0x0044,0x0065,0x006E,0x0020,0x0074,0x0069,0x0064,0x0073,0x0062,0x0065,0x0073,0x0074,0x00E4,0x006D,0x0064,0x0061,
	0x0020,0x006D,0x00E4,0x0074,0x006E,0x0069,0x006E,0x0067,0x0065,0x006E,0x0020,0x00E4,0x0072,0x0020,0x0070,0x00E5,
	0x0020,0x0076,0x00E4,0x0067,0x0020,0x0061,0x0074,0x0074,0x0020,0x0073,0x0074,0x0061,0x0072,0x0074,0x0061,0x002C,
	0x0020,0x006F,0x0063,0x0068,0x0020,0x0064,0x0065,0x006E,0x006E,0x0061,0x0020,0x006D,0x00E4,0x0074,0x006E,0x0069,
	0x006E,0x0067,0x0020,0x00E4,0x0072,0x0020,0x0073,0x006C,0x0075,0x0074,0x0066,0x00F6,0x0072,0x0064,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_JP_ENABLE
uint16_t ppg_timing_notify_jp[] =
{
	//定期測定が間もなく開始されます。本測定は終了しました！
	0x5B9A,0x671F,0x6E2C,0x5B9A,0x304C,0x9593,0x3082,0x306A,0x304F,0x958B,0x59CB,0x3055,0x308C,0x307E,0x3059,0x3002,
	0x672C,0x6E2C,0x5B9A,0x306F,0x7D42,0x4E86,0x3057,0x307E,0x3057,0x305F,0xFF01,0x0000
};
#endif
#ifdef LANGUAGE_KR_ENABLE
uint16_t ppg_timing_notify_kr[] =
{
	//?? ??? ? ?????. ?? ??? ???????!
	0xC815,0xAE30,0x0020,0xCE21,0xC815,0xC774,0x0020,0xACE7,0x0020,0xC2DC,0xC791,0xB429,0xB2C8,0xB2E4,0x002E,0x0020,
	0xC774,0xBC88,0x0020,0xCE21,0xC815,0xC740,0x0020,0xC885,0xB8CC,0xB418,0xC5C8,0xC2B5,0xB2C8,0xB2E4,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_RU_ENABLE
uint16_t ppg_timing_notify_ru[] =
{
	//Измерение с таймером вот-вот начнется, и это измерение завершено!
	0x0418,0x0437,0x043C,0x0435,0x0440,0x0435,0x043D,0x0438,0x0435,0x0020,0x0441,0x0020,0x0442,0x0430,0x0439,0x043C,
	0x0435,0x0440,0x043E,0x043C,0x0020,0x0432,0x043E,0x0442,0x2013,0x0432,0x043E,0x0442,0x0020,0x043D,0x0430,0x0447,
	0x043D,0x0435,0x0442,0x0441,0x044F,0x002C,0x0020,0x0438,0x0020,0x044D,0x0442,0x043E,0x0020,0x0438,0x0437,0x043C,
	0x0435,0x0440,0x0435,0x043D,0x0438,0x0435,0x0020,0x0437,0x0430,0x0432,0x0435,0x0440,0x0448,0x0435,0x043D,0x043E,
	0x0021,0x0000
};
#endif
#ifdef LANGUAGE_AR_ENABLE
uint16_t ppg_timing_notify_ar[] =
{
	//???? ??????? ??? ??? ?????? ??? ????? ??? ??????!
	0x0642,0x064A,0x0627,0x0633,0x0020,0x0627,0x0644,0x062A,0x0648,0x0642,0x064A,0x062A,0x0020,0x0639,0x0644,0x0649,
	0x0020,0x0648,0x0634,0x0643,0x0020,0x0627,0x0644,0x0628,0x062F,0x0621,0x060C,0x0020,0x0648,0x0642,0x062F,0x0020,
	0x0627,0x0643,0x062A,0x0645,0x0644,0x0020,0x0647,0x0630,0x0627,0x0020,0x0627,0x0644,0x0642,0x064A,0x0627,0x0633,
	0x0021,0x0000
};
#endif
#else
#ifdef LANGUAGE_CN_ENABLE
uint16_t ppg_timing_notify_cn[] =
{
	//定时测量即将开始，本次测量结束！
	0x5B9A,0x65F6,0x6D4B,0x91CF,0x5373,0x5C06,0x5F00,0x59CB,0xFF0C,0x672C,0x6B21,0x6D4B,0x91CF,0x7ED3,0x675F,0xFF01,
	0x0000
};
#endif
#ifdef LANGUAGE_EN_ENABLE
uint16_t ppg_timing_notify_en[] =
{
	//The timing measurement is about to start, and this measurement is over!
	0x0054,0x0068,0x0065,0x0020,0x0074,0x0069,0x006D,0x0069,0x006E,0x0067,0x0020,0x006D,0x0065,0x0061,0x0073,0x0075,
	0x0072,0x0065,0x006D,0x0065,0x006E,0x0074,0x0020,0x0069,0x0073,0x0020,0x0061,0x0062,0x006F,0x0075,0x0074,0x0020,
	0x0074,0x006F,0x0020,0x0073,0x0074,0x0061,0x0072,0x0074,0x002C,0x0020,0x0061,0x006E,0x0064,0x0020,0x0074,0x0068,
	0x0069,0x0073,0x0020,0x006D,0x0065,0x0061,0x0073,0x0075,0x0072,0x0065,0x006D,0x0065,0x006E,0x0074,0x0020,0x0069,
	0x0073,0x0020,0x006F,0x0076,0x0065,0x0072,0x0021,0x0000
};
#endif
#endif
...
#ifndef FW_FOR_CN
#ifdef LANGUAGE_EN_ENABLE
uint16_t ppg_running_notify_en[] =
{
	//The sensor is running, please try again later!
	0x0054,0x0068,0x0065,0x0020,0x0073,0x0065,0x006E,0x0073,0x006F,0x0072,0x0020,0x0069,0x0073,0x0020,0x0072,0x0075,
	0x006E,0x006E,0x0069,0x006E,0x0067,0x002C,0x0020,0x0070,0x006C,0x0065,0x0061,0x0073,0x0065,0x0020,0x0074,0x0072,
	0x0079,0x0020,0x0061,0x0067,0x0061,0x0069,0x006E,0x0020,0x006C,0x0061,0x0074,0x0065,0x0072,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_DE_ENABLE
uint16_t ppg_running_notify_de[] =
{
	//Der Sensor l?uft, bitte versuchen Sie es sp?ter erneut!
	0x0044,0x0065,0x0072,0x0020,0x0053,0x0065,0x006E,0x0073,0x006F,0x0072,0x0020,0x006C,0x00E4,0x0075,0x0066,0x0074,
	0x002C,0x0020,0x0062,0x0069,0x0074,0x0074,0x0065,0x0020,0x0076,0x0065,0x0072,0x0073,0x0075,0x0063,0x0068,0x0065,
	0x006E,0x0020,0x0053,0x0069,0x0065,0x0020,0x0065,0x0073,0x0020,0x0073,0x0070,0x00E4,0x0074,0x0065,0x0072,0x0020,
	0x0065,0x0072,0x006E,0x0065,0x0075,0x0074,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_FR_ENABLE
uint16_t ppg_running_notify_fr[] =
{
	//Le capteur est en cours d'exécution, veuillez réessayer plus tard!
	0x004C,0x0065,0x0020,0x0063,0x0061,0x0070,0x0074,0x0065,0x0075,0x0072,0x0020,0x0065,0x0073,0x0074,0x0020,0x0065,
	0x006E,0x0020,0x0063,0x006F,0x0075,0x0072,0x0073,0x0020,0x0064,0x0027,0x0065,0x0078,0x00E9,0x0063,0x0075,0x0074,
	0x0069,0x006F,0x006E,0x002C,0x0020,0x0076,0x0065,0x0075,0x0069,0x006C,0x006C,0x0065,0x007A,0x0020,0x0072,0x00E9,
	0x0065,0x0073,0x0073,0x0061,0x0079,0x0065,0x0072,0x0020,0x0070,0x006C,0x0075,0x0073,0x0020,0x0074,0x0061,0x0072,
	0x0064,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_IT_ENABLE
uint16_t ppg_running_notify_it[] =
{
	//Il sensore è in esecuzione, riprova più tardi!
	0x0049,0x006C,0x0020,0x0073,0x0065,0x006E,0x0073,0x006F,0x0072,0x0065,0x0020,0x00E8,0x0020,0x0069,0x006E,0x0020,
	0x0065,0x0073,0x0065,0x0063,0x0075,0x007A,0x0069,0x006F,0x006E,0x0065,0x002C,0x0020,0x0072,0x0069,0x0070,0x0072,
	0x006F,0x0076,0x0061,0x0020,0x0070,0x0069,0x00F9,0x0020,0x0074,0x0061,0x0072,0x0064,0x0069,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_ES_ENABLE
uint16_t ppg_running_notify_es[] =
{
	//El sensor se está ejecutando, ?inténtelo de nuevo más tarde!
	0x0045,0x006C,0x0020,0x0073,0x0065,0x006E,0x0073,0x006F,0x0072,0x0020,0x0073,0x0065,0x0020,0x0065,0x0073,0x0074,
	0x00E1,0x0020,0x0065,0x006A,0x0065,0x0063,0x0075,0x0074,0x0061,0x006E,0x0064,0x006F,0x002C,0x0020,0x00A1,0x0069,
	0x006E,0x0074,0x00E9,0x006E,0x0074,0x0065,0x006C,0x006F,0x0020,0x0064,0x0065,0x0020,0x006E,0x0075,0x0065,0x0076,
	0x006F,0x0020,0x006D,0x00E1,0x0073,0x0020,0x0074,0x0061,0x0072,0x0064,0x0065,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_PT_ENABLE
uint16_t ppg_running_notify_pt[] =
{
	//O sensor está funcionando, tente novamente mais tarde!
	0x004F,0x0020,0x0073,0x0065,0x006E,0x0073,0x006F,0x0072,0x0020,0x0065,0x0073,0x0074,0x00E1,0x0020,0x0066,0x0075,
	0x006E,0x0063,0x0069,0x006F,0x006E,0x0061,0x006E,0x0064,0x006F,0x002C,0x0020,0x0074,0x0065,0x006E,0x0074,0x0065,
	0x0020,0x006E,0x006F,0x0076,0x0061,0x006D,0x0065,0x006E,0x0074,0x0065,0x0020,0x006D,0x0061,0x0069,0x0073,0x0020,
	0x0074,0x0061,0x0072,0x0064,0x0065,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_PL_ENABLE
uint16_t ppg_running_notify_pl[] =
{
	//Czujnik dzia?a, spróbuj ponownie pó?niej!
	0x0043,0x007A,0x0075,0x006A,0x006E,0x0069,0x006B,0x0020,0x0064,0x007A,0x0069,0x0061,0x0142,0x0061,0x002C,0x0020,
	0x0073,0x0070,0x0072,0x00F3,0x0062,0x0075,0x006A,0x0020,0x0070,0x006F,0x006E,0x006F,0x0077,0x006E,0x0069,0x0065,
	0x0020,0x0070,0x00F3,0x017A,0x006E,0x0069,0x0065,0x006A,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_SE_ENABLE
uint16_t ppg_running_notify_se[] =
{
	//Sensorn ?r ig?ng, v?nligen f?rs?k igen senare!
	0x0053,0x0065,0x006E,0x0073,0x006F,0x0072,0x006E,0x0020,0x00E4,0x0072,0x0020,0x0069,0x0067,0x00E5,0x006E,0x0067,
	0x002C,0x0020,0x0076,0x00E4,0x006E,0x006C,0x0069,0x0067,0x0065,0x006E,0x0020,0x0066,0x00F6,0x0072,0x0073,0x00F6,
	0x006B,0x0020,0x0069,0x0067,0x0065,0x006E,0x0020,0x0073,0x0065,0x006E,0x0061,0x0072,0x0065,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_JP_ENABLE
uint16_t ppg_running_notify_jp[] =
{
	//センサーが動作中です。後で再試行してください！
	0x30BB,0x30F3,0x30B5,0x30FC,0x304C,0x52D5,0x4F5C,0x4E2D,0x3067,0x3059,0x3002,0x5F8C,0x3067,0x518D,0x8A66,0x884C,
	0x3057,0x3066,0x304F,0x3060,0x3055,0x3044,0xFF01,0x0000
};
#endif
#ifdef LANGUAGE_KR_ENABLE
uint16_t ppg_running_notify_kr[] =
{
	//??? ?? ????. ?? ? ?? ??? ???!
	0xC13C,0xC11C,0xAC00,0x0020,0xC791,0xB3D9,0x0020,0xC911,0xC785,0xB2C8,0xB2E4,0x002E,0x0020,0xC7A0,0xC2DC,0x0020,
	0xD6C4,0x0020,0xB2E4,0xC2DC,0x0020,0xC2DC,0xB3C4,0xD574,0x0020,0xC8FC,0xC138,0xC694,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_RU_ENABLE
uint16_t ppg_running_notify_ru[] =
{
	//Датчик работает, пожалуйста, попробуйте позже!
	0x0414,0x0430,0x0442,0x0447,0x0438,0x043A,0x0020,0x0440,0x0430,0x0431,0x043E,0x0442,0x0430,0x0435,0x0442,0x002C,
	0x0020,0x043F,0x043E,0x0436,0x0430,0x043B,0x0443,0x0439,0x0441,0x0442,0x0430,0x002C,0x0020,0x043F,0x043E,0x043F,
	0x0440,0x043E,0x0431,0x0443,0x0439,0x0442,0x0435,0x0020,0x043F,0x043E,0x0437,0x0436,0x0435,0x0021,0x0000
};
#endif
#ifdef LANGUAGE_AR_ENABLE
uint16_t ppg_running_notify_ar[] =
{
	//???????? ??? ???????? ???? ??? ???? ??????!
	0x0627,0x0644,0x0645,0x0633,0x062A,0x0634,0x0639,0x0631,0x0020,0x0642,0x064A,0x062F,0x0020,0x0627,0x0644,0x062A,
	0x0634,0x063A,0x064A,0x0644,0x060C,0x0020,0x062D,0x0627,0x0648,0x0644,0x0020,0x0645,0x0631,0x0629,0x0020,0x0623,
	0x062E,0x0631,0x0649,0x0020,0x0644,0x0627,0x062D,0x0642,0x064B,0x0627,0x0021,0x0000
};
#endif
#else
#ifdef LANGUAGE_CN_ENABLE
uint16_t ppg_running_notify_cn[] =
{
	//传感器正在运行，请稍后再试！
	0x4F20,0x611F,0x5668,0x6B63,0x5728,0x8FD0,0x884C,0xFF0C,0x8BF7,0x7A0D,0x540E,0x518D,0x8BD5,0xFF01,0x0000
};
#endif
#ifdef LANGUAGE_EN_ENABLE
uint16_t ppg_running_notify_en[] =
...
void StartPPG(PPG_DATA_TYPE data_type, PPG_TRIGGER_SOURCE trigger_type)
{
	...
	case TRIGGER_BY_HOURLY:
		...
		if(IsInPPGScreen())
		{
			uint16_t *str_timing_note[LANGUAGE_MAX] = {
														#ifndef FW_FOR_CN
														  #ifdef LANGUAGE_EN_ENABLE
																ppg_timing_notify_en,
														  #endif
														  #ifdef LANGUAGE_DE_ENABLE
																ppg_timing_notify_de,
														  #endif
														  #ifdef LANGUAGE_FR_ENABLE
																ppg_timing_notify_fr,
														  #endif
														  #ifdef LANGUAGE_IT_ENABLE
																ppg_timing_notify_it,
														  #endif
														  #ifdef LANGUAGE_ES_ENABLE
																ppg_timing_notify_es,
														  #endif
														  #ifdef LANGUAGE_PT_ENABLE
																ppg_timing_notify_pt,
														  #endif
														  #ifdef LANGUAGE_PL_ENABLE
																ppg_timing_notify_pl,
														  #endif
														  #ifdef LANGUAGE_SE_ENABLE
																ppg_timing_notify_se,
														  #endif
														  #ifdef LANGUAGE_JP_ENABLE
																ppg_timing_notify_jp,
														  #endif
														  #ifdef LANGUAGE_KR_ENABLE
																ppg_timing_notify_kr,
														  #endif
														  #ifdef LANGUAGE_RU_ENABLE
																ppg_timing_notify_ru,
														  #endif
														  #ifdef LANGUAGE_AR_ENABLE
																ppg_timing_notify_ar,
														  #endif
														#else
														  #ifdef LANGUAGE_CN_ENABLE
																ppg_timing_notify_cn,
														  #endif
														  #ifdef LANGUAGE_EN_ENABLE
																ppg_timing_notify_en,
														  #endif
	...
	case TRIGGER_BY_MENU:
		...
		{
			uint16_t *str_running_note[LANGUAGE_MAX] = {
														#ifndef FW_FOR_CN
														  #ifdef LANGUAGE_EN_ENABLE
																ppg_running_notify_en,
														  #endif
														  #ifdef LANGUAGE_DE_ENABLE
																ppg_running_notify_de,
														  #endif
														  #ifdef LANGUAGE_FR_ENABLE
																ppg_running_notify_fr,
														  #endif
														  #ifdef LANGUAGE_IT_ENABLE
																ppg_running_notify_it,
														  #endif
														  #ifdef LANGUAGE_ES_ENABLE
																ppg_running_notify_es,
														  #endif
														  #ifdef LANGUAGE_PT_ENABLE
																ppg_running_notify_pt,
														  #endif
														  #ifdef LANGUAGE_PL_ENABLE
																ppg_running_notify_pl,
														  #endif
														  #ifdef LANGUAGE_SE_ENABLE
																ppg_running_notify_se,
														  #endif
														  #ifdef LANGUAGE_JP_ENABLE
																ppg_running_notify_jp,
														  #endif
														  #ifdef LANGUAGE_KR_ENABLE
																ppg_running_notify_kr,
														  #endif
														  #ifdef LANGUAGE_RU_ENABLE
																ppg_running_notify_ru,
														  #endif
														  #ifdef LANGUAGE_AR_ENABLE
																ppg_running_notify_ar,
														  #endif
														#else
														  #ifdef LANGUAGE_CN_ENABLE
																ppg_running_notify_cn,
														  #endif
														  #ifdef LANGUAGE_EN_ENABLE
																ppg_running_notify_en,
														  #endif
