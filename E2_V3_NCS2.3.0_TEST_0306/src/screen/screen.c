	...
	case SETTINGS_MENU_OTA:
		{
			...
			uint16_t str_notify[LANGUAGE_MAX][30] = {
													  ...
													  #endif
													  #ifdef LANGUAGE_ES_ENABLE
														{0x0045,0x0073,0x0020,0x006C,0x0061,0x0020,0x00FA,0x006C,0x0074,0x0069,0x006D,0x0061,0x0020,0x0076,0x0065,0x0072,0x0073,0x0069,0x006F,0x006E,0x002E,0x0000},//Es la última version.
													  #endif
													  #ifdef LANGUAGE_PT_ENABLE
