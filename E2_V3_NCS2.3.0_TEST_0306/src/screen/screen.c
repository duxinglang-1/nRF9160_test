...
static uint16_t still_str[LANGUAGE_MAX][21] = {
											#ifndef FW_FOR_CN
												...
												{0x0048,0x00E5,0x006C,0x006C,0x0020,0x0064,0x0069,0x0067,0x0020,0x0073,0x0074,0x0069,0x006C,0x006C,0x0061,0x0000},//H?ll dig stilla
												{0x3058,0x3063,0x3068,0x3057,0x3066,0x3044,0x3066,0x304F,0x3060,0x3055,0x3044,0x0000},//じっとしていてください
												{0xAC00,0xB9CC,0xD788,0x0020,0xC788,0xC5B4,0x0000},//??? ??
												{0x041E,0x0441,0x0442,0x0430,0x0432,0x0430,0x0439,0x0442,0x0435,0x0441,0x044C,0x0020,0x043D,0x0430,0x0020,0x043C,0x0435,0x0441,0x0442,0x0435,0x0000},//Оставайтесь на месте
												{0x039C,0x03B5,0x03AF,0x03BD,0x03B5,0x0020,0x03B1,0x03BA,0x03AF,0x03BD,0x03B7,0x03C4,0x03BF,0x03C2,0x0000},//Με?νε ακ?νητο?
											#else
												{0x4FDD,0x6301,0x9759,0x6B62,0x0000},//保持静止
												{0x0053,0x0074,0x0061,0x0079,0x0020,0x0073,0x0074,0x0069,0x006C,0x006C,0x0000},//Stay still
											#endif
											  };
static uint16_t Incon_1_str[LANGUAGE_MAX][40] = {
												#ifndef FW_FOR_CN
													...
													{0x004E,0x0069,0x0065,0x006A,0x0065,0x0064,0x006E,0x006F,0x007A,0x006E,0x0061,0x0063,0x007A,0x006E,0x0061,0x0020,0x0070,0x006F,0x006E,0x006F,0x0077,0x006E,0x0061,0x0020,0x0070,0x0072,0x00F3,0x0062,0x0061,0x0020,0x0070,0x00F3,0x017A,0x006E,0x0069,0x0065,0x006A,0x0000},//Niejednoznaczna ponowna próba pó?niej
													{0x0046,0x00F6,0x0072,0x0073,0x00F6,0x006B,0x0020,0x0069,0x0067,0x0065,0x006E,0x0020,0x0073,0x0065,0x006E,0x0061,0x0072,0x0065,0x0000},//F?rs?k igen senare
													{0x5F8C,0x3067,0x518D,0x8A66,0x884C,0x3057,0x3066,0x3082,0x7D50,0x8AD6,0x304C,0x51FA,0x306A,0x3044,0x0000},//後で再試行しても結論が出ない
													{0xACB0,0xB860,0xC774,0x0020,0xB098,0xC9C0,0x0020,0xC54A,0xC544,0x0020,0xB098,0xC911,0xC5D0,0x0020,0xB2E4,0xC2DC,0x0020,0xC2DC,0xB3C4,0xD558,0xC138,0xC694,0x0000},//??? ?? ?? ??? ?? ?????
													{0x0411,0x0435,0x0437,0x0440,0x0435,0x0437,0x0443,0x043B,0x044C,0x0442,0x0430,0x0442,0x043D,0x0430,0x044F,0x0020,0x043F,0x043E,0x0432,0x0442,0x043E,0x0440,0x043D,0x0430,0x044F,0x0020,0x043F,0x043E,0x043F,0x044B,0x0442,0x043A,0x0430,0x0020,0x043F,0x043E,0x0437,0x0436,0x0435,0x0000},//Безрезультатная повторная попытка позже
													{0x0391,0x03C3,0x03CD,0x03BB,0x03BB,0x03B7,0x03C0,0x03C4,0x03B7,0x0020,0x03B5,0x03C0,0x03B1,0x03BD,0x03AC,0x03BB,0x03B7,0x03C8,0x03B7,0x0020,0x03B1,0x03C1,0x03B3,0x03CC,0x03C4,0x03B5,0x03C1,0x03B1,0x0000},//Ασ?λληπτη επαν?ληψη αργ?τερα
												#else
													{0x6D4B,0x91CF,0x5931,0x8D25,0xFF0C,0x8BF7,0x7A0D,0x540E,0x91CD,0x8BD5,0x0000},//测量失败，请稍后重试
													{0x0049,0x006E,0x0063,0x006F,0x006E,0x0063,0x006C,0x0075,0x0073,0x0069,0x0076,0x0065,0x0020,0x0072,0x0065,0x0074,0x0072,0x0079,0x0020,0x006C,0x0061,0x0074,0x0065,0x0072,0x0000},//Inconclusive retry later
												#endif
												};
static uint16_t Incon_2_str[LANGUAGE_MAX][18] = {
												#ifndef FW_FOR_CN
													...
													{0x004E,0x0069,0x0065,0x0070,0x0072,0x007A,0x0065,0x006B,0x006F,0x006E,0x0079,0x0077,0x0075,0x006A,0x0105,0x0063,0x0079,0x0000},//Nieprzekonywuj?cy
													{0x0049,0x006E,0x0074,0x0065,0x0020,0x00F6,0x0076,0x0065,0x0072,0x0074,0x0079,0x0067,0x0061,0x006E,0x0064,0x0065,0x0000},//Inte ?vertygande
													{0x7D50,0x8AD6,0x304C,0x51FA,0x306A,0x3044,0x0000},//結論が出ない
													{0xACB0,0xB860,0xC774,0x0020,0xB098,0xC9C0,0x0020,0xC54A,0xC74C,0x0000},//??? ?? ??
													{0x041D,0x0435,0x043E,0x043A,0x043E,0x043D,0x0447,0x0430,0x0442,0x0435,0x043B,0x044C,0x043D,0x044B,0x0439,0x0000},//Неокончательный
													{0x039C,0x03B7,0x0020,0x03C4,0x03B5,0x03BB,0x03B5,0x03C3,0x03AF,0x03B4,0x03B9,0x03BA,0x03BF,0x03C2,0x0000},//Μη τελεσ?δικο?
												#else
													{0x6D4B,0x91CF,0x5931,0x8D25,0x0000},//测量失败
													{0x0049,0x006E,0x0063,0x006F,0x006E,0x0063,0x006C,0x0075,0x0073,0x0069,0x0076,0x0065,0x0000},//Inconclusive
												#endif
												};
static uint16_t still_retry_str[LANGUAGE_MAX][42] = {
													#ifndef FW_FOR_CN
														...
														{0x0050,0x006F,0x007A,0x006F,0x0073,0x0074,0x0061,0x0144,0x0020,0x0077,0x0020,0x0062,0x0065,0x007A,0x0072,0x0075,0x0063,0x0068,0x0075,0x0020,0x0069,0x0020,0x0073,0x0070,0x0072,0x00F3,0x0062,0x0075,0x006A,0x0020,0x0070,0x006F,0x006E,0x006F,0x0077,0x006E,0x0069,0x0065,0x0000},//Pozostań w bezruchu i spróbuj ponownie
														{0x0048,0x00E5,0x006C,0x006C,0x0020,0x0064,0x0069,0x0067,0x0020,0x0073,0x0074,0x0069,0x006C,0x006C,0x0061,0x0020,0x006F,0x0063,0x0068,0x0020,0x0066,0x00F6,0x0072,0x0073,0x00F6,0x006B,0x0020,0x0069,0x0067,0x0065,0x006E,0x0000},//H?ll dig stilla och f?rs?k igen
														{0x3058,0x3063,0x3068,0x3057,0x305F,0x307E,0x307E,0x518D,0x8A66,0x884C,0x3057,0x3066,0x304F,0x3060,0x3055,0x3044,0x0000},//じっとしたまま再試行してください
														{0xAC00,0xB9CC,0xD788,0x0020,0xC788,0xACE0,0x0020,0xB2E4,0xC2DC,0x0020,0xC2DC,0xB3C4,0xD558,0xC138,0xC694,0x0000},//??? ?? ?? ?????
														{0x041E,0x0441,0x0442,0x0430,0x0432,0x0430,0x0439,0x0442,0x0435,0x0441,0x044C,0x0020,0x043D,0x0430,0x0020,0x043C,0x0435,0x0441,0x0442,0x0435,0x0020,0x0438,0x0020,0x043F,0x043E,0x0432,0x0442,0x043E,0x0440,0x0438,0x0442,0x0435,0x0020,0x043F,0x043E,0x043F,0x044B,0x0442,0x043A,0x0443,0x002E,0x0000},//Оставайтесь на месте и повторите попытку.
														{0x039C,0x03B5,0x03AF,0x03BD,0x03B5,0x03C4,0x03B5,0x0020,0x03B1,0x03BA,0x03AF,0x03BD,0x03B7,0x03C4,0x03BF,0x03B9,0x0020,0x03BA,0x03B1,0x03B9,0x0020,0x03B4,0x03BF,0x03BA,0x03B9,0x03BC,0x03AC,0x03C3,0x03C4,0x03B5,0x0020,0x03BE,0x03B1,0x03BD,0x03AC,0x0000},//Με?νετε ακ?νητοι και δοκιμ?στε ξαν?
													#else
...
void IdleShowSystemDate(void)
{
	...
	uint16_t str_mon[LANGUAGE_MAX][12][7] = {
												...
												{//Polish
													{0x0053,0x0074,0x0079,0x0000},//Sty
													{0x004C,0x0075,0x0074,0x0000},//Lut
													{0x004D,0x0061,0x0072,0x0000},//Mar
													{0x004B,0x0077,0x0069,0x0000},//Kwi
													{0x004D,0x0061,0x006A,0x0000},//Maj
													{0x0043,0x007A,0x0065,0x0000},//Cze
													{0x004C,0x0069,0x0070,0x0000},//Lip
													{0x0053,0x0069,0x0065,0x0000},//Sie
													{0x0057,0x0072,0x007A,0x0000},//Wrz
													{0x0050,0x0061,0x017A,0x0000},//Pa?
													{0x004C,0x0069,0x0073,0x0000},//Lis
													{0x0047,0x0072,0x0075,0x0000},//Gru
												},
												{//Swedish
													{0x004A,0x0061,0x006E,0x0000,0x0000},//Jan
													{0x0046,0x0065,0x0062,0x0000,0x0000},//Feb
												...
												{//Russian
													{0x042F,0x043D,0x0432,0x002E,0x0000},//Янв.
													{0x0424,0x0435,0x0432,0x0440,0x002E,0x0000},//Февр.
													{0x041C,0x0430,0x0440,0x0442,0x0000},//Март
													{0x0410,0x043F,0x0440,0x002E,0x0000},//Апр.
													{0x041C,0x0430,0x0439,0x0000},//Май
													{0x0418,0x044E,0x043D,0x002E,0x0000},//Июн.
													{0x0418,0x044E,0x043B,0x002E,0x0000},//Июл.
													{0x0410,0x0432,0x0433,0x002E,0x0000},//Авг.
													{0x0421,0x0435,0x043D,0x0442,0x002E,0x0000},//Сент.
													{0x041E,0x043A,0x0442,0x002E,0x0000},//Окт.
													{0x041D,0x043E,0x044F,0x0431,0x0440,0x002E,0x0000},//Ноябр.
													{0x0414,0x0435,0x043A,0x002E,0x0000},//Дек.
												},
												{//Greece
													{0x0399,0x03B1,0x03BD,0x002E,0x0000},//Ιαν.
													{0x03A6,0x03B5,0x03B2,0x002E,0x0000},//Φεβ.
													{0x039C,0x03B1,0x03C1,0x002E,0x0000},//Μαρ.
													{0x0391,0x03C0,0x03C1,0x002E,0x0000},//Απρ.
													{0x039C,0x03B1,0x03B9,0x002E,0x0000},//Μαι.
													{0x0399,0x03BF,0x03C5,0x03BD,0x002E,0x0000},//Ιουν.
													{0x0399,0x03BF,0x03C5,0x03BB,0x002E,0x0000},//Ιουλ.
													{0x0391,0x03C5,0x03B3,0x002E,0x0000},//Αυγ.
													{0x03A3,0x03B5,0x03C0,0x03C4,0x002E,0x0000},//Σεπτ.
													{0x039F,0x03BA,0x03C4,0x002E,0x0000},//Οκτ.
													{0x039D,0x03BF,0x03B5,0x002E,0x0000},//Νοε.
													{0x0394,0x03B5,0x03BA,0x002E,0x0000},//Δεκ.
												},
											#else
												{
...
void IdleShowSystemWeek(void)
{
	uint16_t x,y,w,h;
#ifdef FONTMAKER_UNICODE_FONT	
	uint16_t str_week[LANGUAGE_MAX][7][6] = {
											#ifndef FW_FOR_CN
												{//English
												...
												{//Polish
													...
													{0x0050,0x006F,0x006E,0x0000},//Pon
													{0x0057,0x0074,0x006F,0x0000},//Wto
													{0x015A,0x0072,0x006F,0x0000},//?ro
													{0x0043,0x007A,0x0077,0x0000},//Czw
													{0x0050,0x0069,0x0105,0x0000},//Pi?
													{0x0053,0x006F,0x0062,0x0000},//Sat
												},
												{//Swedish
													{0x0053,0x006F,0x0000},//So
													{0x004D,0x006F,0x0000},//Mo
													{0x0054,0x0075,0x0000},//Tu
													{0x0057,0x0065,0x0000},//We
													{0x0054,0x0068,0x0000},//Th
													{0x0046,0x0072,0x0000},//Fr
													{0x0053,0x0061,0x0000},//Sa
												},
												{//Japanese
													{0x30CB,0x30C1,0x0000},//ニチ
													{0x30B2,0x30C4,0x0000},//ゲツ
													{0x30AB,0x0000},//カ
													{0x30B9,0x30A4,0x0000},//スイ
													{0x30E2,0x30AF,0x0000},//モク
													{0x30AD,0x30F3,0x0000},//キン
													{0x30C9,0x30A6,0x0000},//ドウ
												},
												{//Korea
												...
												{//Greece
													{0x039A,0x03C5,0x03C1,0x002E,0x0000},//Κυρ.
													{0x0394,0x03B5,0x03C5,0x03C4,0x002E,0x0000},//Δευτ.
													{0x03A4,0x03C1,0x03AF,0x0000},//Τρ?
													{0x03A4,0x03B5,0x03C4,0x002E,0x0000},//Τετ.
													{0x03A0,0x03B5,0x03BC,0x002E,0x0000},//Πεμ.
													{0x03A0,0x03B1,0x03C1,0x002E,0x0000},//Παρ.
													{0x03A3,0x03B1,0x03B2,0x002E,0x0000},//Σαβ.
												},
											#else	
												{
...
void SettingsUpdateStatus(void)
{
	...
	case SETTINGS_MENU_MAIN:
		{
			uint16_t lang_sle_str[LANGUAGE_MAX][10] = {
														...
														{0x03B5,0x03BB,0x03BB,0x03B7,0x03BD,0x03B9,0x03BA,0x03AC,0x0000},//ελληνικ?
													#else
			...
			uint16_t menu_sle_str[LANGUAGE_MAX][3][14] = {
															...
															{
																{0x0050,0x006F,0x0067,0x006C,0x0105,0x0064,0x0000},//Pogl?d
																{0x0000},//null
																{0x004E,0x0061,0x0073,0x0074,0x0061,0x0077,0x0069,0x0107,0x0000},//Nastawi?
															},
															{
																{0x0053,0x0065,0x0000},//Se
																{0x0000},//null
																{0x00C5,0x0074,0x0065,0x0072,0x0073,0x0074,0x00E4,0x006C,0x006C,0x0061,0x0000},//?terst?lla
															},
															{
																{0x30D3,0x30E5,0x30FC,0x0000},//ビュー
																{0x0000},//null
																{0x30EA,0x30BB,0x30C3,0x30C8,0x0000},//リセット
															},
															{
																{0xBCF4,0xB2E4,0x0000},//??
																{0x0000},//null
																{0xB2E4,0xC2DC,0x0020,0xB193,0xAE30,0x0000},//?? ??
															},
															{
																{0x0412,0x0438,0x0434,0x0000},//Вид
																{0x0000},//null
																{0x041F,0x0435,0x0440,0x0435,0x0437,0x0430,0x0433,0x0440,0x0443,0x0437,0x0438,0x0442,0x044C,0x0000},//Перезагрузить
															},
															{
																{0x0398,0x03AD,0x03B1,0x0000},//Θ?α
																{0x0000},//null
																{0x0395,0x03C0,0x03B1,0x03BD,0x03B1,0x03C6,0x03BF,0x03C1,0x03AC,0x0000},//Επαναφορ?
															},
														#else	
															{
			...
			uint16_t level_str[LANGUAGE_MAX][4][10] = {
														...
														{
															{0x0395,0x03C0,0x03AF,0x03C0,0x03B5,0x03B4,0x03BF,0x0020,0x0031,0x0000},//Επ?πεδο 1
															{0x0395,0x03C0,0x03AF,0x03C0,0x03B5,0x03B4,0x03BF,0x0020,0x0032,0x0000},//Επ?πεδο 2
															{0x0395,0x03C0,0x03AF,0x03C0,0x03B5,0x03B4,0x03BF,0x0020,0x0033,0x0000},//Επ?πεδο 3
															{0x0395,0x03C0,0x03AF,0x03C0,0x03B5,0x03B4,0x03BF,0x0020,0x0034,0x0000},//Επ?πεδο 4
														},
													#else	
														{
			...
			case RESET_STATUS_IDLE:
				{
					uint16_t str_ready[LANGUAGE_MAX][44] = {
																...
																{0x0050,0x0072,0x007A,0x0079,0x0077,0x0072,0x00F3,0x0107,0x0020,0x0075,0x0073,0x0074,0x0061,0x0077,0x0069,0x0065,0x006E,0x0069,0x0061,0x0020,0x0066,0x0061,0x0062,0x0072,0x0079,0x0063,0x007A,0x006E,0x0065,0x0000},//Przywró? ustawienia fabryczne
																{0x00C5,0x0074,0x0065,0x0072,0x0073,0x0074,0x00E4,0x006C,0x006C,0x0020,0x0074,0x0069,0x006C,0x006C,0x0020,0x0066,0x0061,0x0062,0x0072,0x0069,0x006B,0x0073,0x0069,0x006E,0x0073,0x0074,0x00E4,0x006C,0x006C,0x006E,0x0069,0x006E,0x0067,0x0061,0x0072,0x006E,0x0061,0x0000},//?terst?ll till fabriksinst?llningarna
																{0x5DE5,0x5834,0x51FA,0x8377,0x6642,0x306E,0x8A2D,0x5B9A,0x306B,0x30EA,0x30BB,0x30C3,0x30C8,0x3059,0x308B,0x0000},//工場出荷時の設定にリセットする
																{0xACF5,0xC7A5,0x0020,0xC124,0xC815,0xC73C,0xB85C,0x0020,0xC7AC,0xC124,0xC815,0x0000},//?? ???? ???
																...
																{0x0395,0x03C0,0x03B1,0x03BD,0x03B1,0x03C6,0x03BF,0x03C1,0x03AC,0x0020,0x03C3,0x03C4,0x03B9,0x03C2,0x0020,0x03B5,0x03C1,0x03B3,0x03BF,0x03C3,0x03C4,0x03B1,0x03C3,0x03B9,0x03B1,0x03BA,0x03AD,0x03C2,0x0020,0x03C1,0x03C5,0x03B8,0x03BC,0x03AF,0x03C3,0x03B5,0x03B9,0x03C2,0x0000},//Επαναφορ? στι? εργοστασιακ?? ρυθμ?σει?
															#else
			...
			case RESET_STATUS_RUNNING:
				{
					uint16_t str_running[LANGUAGE_MAX][28] = {
																...
																{0x00C5,0x0074,0x0065,0x0072,0x0073,0x0074,0x00E4,0x006C,0x006C,0x006E,0x0069,0x006E,0x0067,0x0020,0x0070,0x00E5,0x0067,0x00E5,0x0072,0x0000},//?terst?llning p?g?r
																{0x30EA,0x30BB,0x30C3,0x30C8,0x4E2D,0x0000},//リセット中
																...
																{0x0395,0x03C0,0x03B1,0x03BD,0x03B1,0x03C6,0x03BF,0x03C1,0x03AC,0x0020,0x03C3,0x03B5,0x0020,0x03B5,0x03BE,0x03AD,0x03BB,0x03B9,0x03BE,0x03B7,0x0000},//Επαναφορ? σε εξ?λιξη
															#else
			...
			case RESET_STATUS_SUCCESS:
				{
					uint16_t str_success[LANGUAGE_MAX][26] = {
																...
																{0x0052,0x0065,0x0073,0x0065,0x0074,0x006F,0x0077,0x0061,0x006E,0x0069,0x0065,0x0020,0x0070,0x006F,0x0077,0x0069,0x006F,0x0064,0x0142,0x006F,0x0020,0x0073,0x0069,0x0119,0x0000},//Resetowanie powiod?o si?
																{0x00C5,0x0074,0x0065,0x0072,0x0073,0x0074,0x00E4,0x006C,0x006C,0x006E,0x0069,0x006E,0x0067,0x0065,0x006E,0x0020,0x006C,0x0079,0x0063,0x006B,0x0061,0x0064,0x0065,0x0073,0x0000},//?terst?llningen lyckades
																{0x30EA,0x30BB,0x30C3,0x30C8,0x306B,0x6210,0x529F,0x3057,0x307E,0x3057,0x305F,0x0000},//リセットに成功しました
																{0xC7AC,0xC124,0xC815,0x0020,0xC131,0xACF5,0x0000},//??? ??
																{0x0421,0x0431,0x0440,0x043E,0x0441,0x0020,0x0443,0x0441,0x043F,0x0435,0x0448,0x0435,0x043D,0x0000},//Сброс успешен
																{0x0395,0x03C0,0x03B9,0x03C4,0x03C5,0x03C7,0x03AE,0x03C2,0x0020,0x03B5,0x03C0,0x03B1,0x03BD,0x03B1,0x03C6,0x03BF,0x03C1,0x03AC,0x0000},//Επιτυχ?? επαναφορ?
															#else
			...
			case RESET_STATUS_FAIL:
				{
					uint16_t str_fail[LANGUAGE_MAX][30] = {
																...
																{0x0052,0x0065,0x0073,0x0065,0x0074,0x006F,0x0077,0x0061,0x006E,0x0069,0x0065,0x0020,0x006E,0x0069,0x0065,0x0020,0x0070,0x006F,0x0077,0x0069,0x006F,0x0064,0x0142,0x006F,0x0020,0x0073,0x0069,0x0119,0x0000},//Resetowanie nie powiod?o si?
																{0x00C5,0x0074,0x0065,0x0072,0x0073,0x0074,0x00E4,0x006C,0x006C,0x006E,0x0069,0x006E,0x0067,0x0065,0x006E,0x0020,0x006D,0x0069,0x0073,0x0073,0x006C,0x0079,0x0063,0x006B,0x0061,0x0064,0x0065,0x0073,0x0000},//?terst?llningen misslyckades
																{0x30EA,0x30BB,0x30C3,0x30C8,0x306B,0x5931,0x6557,0x3057,0x307E,0x3057,0x305F,0x0000},//リセットに失敗しました
																{0xC7AC,0xC124,0xC815,0x0020,0xC2E4,0xD328,0x0000},//??? ??
																...
																{0x0397,0x0020,0x03B5,0x03C0,0x03B1,0x03BD,0x03B1,0x03C6,0x03BF,0x03C1,0x03AC,0x0020,0x03B1,0x03C0,0x03AD,0x03C4,0x03C5,0x03C7,0x03B5,0x0000},//Η επαναφορ? απ?τυχε
															#else
	...
	case SETTINGS_MENU_OTA:
		{
			uint16_t tmpbuf[128] = {0};
			uint16_t str_notify[LANGUAGE_MAX][29] = {
													#ifndef FW_FOR_CN
														...
														{0x0054,0x006F,0x0020,0x006A,0x0065,0x0073,0x0074,0x0020,0x006E,0x0061,0x006A,0x006E,0x006F,0x0077,0x0073,0x007A,0x0061,0x0020,0x0077,0x0065,0x0072,0x0073,0x006A,0x0061,0x0000},//To jest najnowsza wersja
														{0x0044,0x0065,0x0074,0x0020,0x00E4,0x0072,0x0020,0x0064,0x0065,0x006E,0x0020,0x0073,0x0065,0x006E,0x0061,0x0073,0x0074,0x0065,0x0020,0x0076,0x0065,0x0072,0x0073,0x0069,0x006F,0x006E,0x0065,0x006E,0x0000},//Det ?r den senaste versionen
														...
														{0x0395,0x03AF,0x03BD,0x03B1,0x03B9,0x0020,0x03B7,0x0020,0x03C4,0x03B5,0x03BB,0x03B5,0x03C5,0x03C4,0x03B1,0x03AF,0x03B1,0x0020,0x03AD,0x03BA,0x03B4,0x03BF,0x03C3,0x03B7,0x0000},//Ε?ναι η τελευτα?α ?κδοση
													#else
	...
	case SETTINGS_MENU_CAREMATE_QR:
		{
			...
			uint16_t str_notify[LANGUAGE_MAX][35] = {
														...
														{0x0391,0x03BD,0x03B1,0x03C0,0x03C4,0x03CD,0x03C3,0x03C3,0x03B5,0x03C4,0x03B1,0x03B9,0x002E,0x0000},//Αναπτ?σσεται.
													#else
...
void TempShowStatus(void)
{
	...
	uint16_t title_str[LANGUAGE_MAX][24] = {
												...
												{0x0054,0x0065,0x006D,0x0070,0x0065,0x0072,0x0061,0x0074,0x0075,0x0072,0x0061,0x0020,0x0063,0x006F,0x0072,0x0070,0x006F,0x0072,0x0061,0x006C,0x0000},//Temperatura corporal
												{0x0054,0x0065,0x006D,0x0070,0x0065,0x0072,0x0061,0x0074,0x0075,0x0072,0x0061,0x0020,0x0063,0x0069,0x0061,0x0142,0x0061,0x0000},//Temperatura cia?a
												...
												{0x0422,0x0435,0x043C,0x043F,0x0435,0x0440,0x0430,0x0442,0x0443,0x0440,0x0430,0x0020,0x0442,0x0435,0x043B,0x0430,0x0000},//Температура тела
												{0x0398,0x03B5,0x03C1,0x03BC,0x03BF,0x03BA,0x03C1,0x03B1,0x03C3,0x03AF,0x03B1,0x0020,0x03C3,0x03CE,0x03BC,0x03B1,0x03C4,0x03BF,0x03C2,0x0000},//Θερμοκρασ?α σ?ματο?
											#else
												{0x4F53,0x6E29,0x0000},//体温
												{0x0042,0x006F,0x0064,0x0079,0x0020,0x0054,0x0065,0x006D,0x0070,0x0065,0x0072,0x0061,0x0074,0x0075,0x0072,0x0065,0x0000},//Body Temperature
											#endif
...
void BPShowStatus(void)
{
	...
	uint16_t title_str[LANGUAGE_MAX][22] = {
												...
												{0x0043,0x0069,0x015B,0x006E,0x0069,0x0065,0x006E,0x0069,0x0065,0x0020,0x006B,0x0072,0x0077,0x0069,0x0000},//Ci?nienie krwi
												...
												{0x0410,0x0440,0x0442,0x0435,0x0440,0x0438,0x0430,0x043B,0x044C,0x043D,0x043E,0x0435,0x0020,0x0434,0x0430,0x0432,0x043B,0x0435,0x043D,0x0438,0x0435,0x0000},//Артериальное давление
												{0x0391,0x03C1,0x03C4,0x03B7,0x03C1,0x03B9,0x03B1,0x03BA,0x03AE,0x0020,0x03C0,0x03AF,0x03B5,0x03C3,0x03B7,0x0000},//Αρτηριακ? π?εση
											#else
...
void SPO2ShowStatus(void)
{
	...
	uint16_t title_str[LANGUAGE_MAX][25] = {
												...
												{0x0054,0x006C,0x0065,0x006E,0x0020,0x0077,0x0065,0x0020,0x006B,0x0072,0x0077,0x0069,0x0000},//Tlen we krwi
												...
												{0x041A,0x0438,0x0441,0x043B,0x043E,0x0440,0x043E,0x0434,0x0020,0x0432,0x0020,0x043A,0x0440,0x043E,0x0432,0x0438,0x0000},//Кислород в крови
												{0x039F,0x03BE,0x03C5,0x03B3,0x03CC,0x03BD,0x03BF,0x0020,0x0391,0x03AF,0x03BC,0x03B1,0x03C4,0x03BF,0x03C2,0x0000},//Οξυγ?νο Α?ματο?
											#else
...
void HRShowStatus(void)
{
	...
	uint16_t title_str[LANGUAGE_MAX][29] = {
												...
												{0x5FC3,0x62CD,0x0000},//心拍
												{0xC2EC,0xBC15,0xC218,0x0000},//???
												{0x0427,0x0430,0x0441,0x0442,0x043E,0x0442,0x0430,0x0020,0x0441,0x0435,0x0440,0x0434,0x0435,0x0447,0x043D,0x044B,0x0445,0x0020,0x0441,0x043E,0x043A,0x0440,0x0430,0x0449,0x0435,0x043D,0x0438,0x0439,0x0000},//Частота сердечных сокращений
												{0x039A,0x03B1,0x03C1,0x03B4,0x03B9,0x03B1,0x03BA,0x03CC,0x03C2,0x0020,0x03C1,0x03C5,0x03B8,0x03BC,0x03CC,0x03C2,0x0000},//Καρδιακ?? ρυθμ??
											#else
...
void FOTAShowStatus(void)
{
	...
	uint16_t str_notify[LANGUAGE_MAX][53] = {
											#ifndef FW_FOR_CN
												...
												{0x004B,0x006F,0x006E,0x0074,0x0079,0x006E,0x0075,0x006F,0x0077,0x0061,0x0107,0x0020,0x0061,0x006B,0x0074,0x0075,0x0061,0x006C,0x0069,0x007A,0x0061,0x0063,0x006A,0x0119,0x0020,0x006F,0x0070,0x0072,0x006F,0x0067,0x0072,0x0061,0x006D,0x006F,0x0077,0x0061,0x006E,0x0069,0x0061,0x0020,0x0073,0x0070,0x0072,0x007A,0x0119,0x0074,0x006F,0x0077,0x0065,0x0067,0x006F,0x003F,0x0000},//Kontynuowa? aktualizacj? oprogramowania sprz?towego?
												{0x0056,0x0069,0x006C,0x006C,0x0020,0x0064,0x0075,0x0020,0x0066,0x006F,0x0072,0x0074,0x0073,0x00E4,0x0074,0x0074,0x0061,0x0020,0x0061,0x0074,0x0074,0x0020,0x0075,0x0070,0x0070,0x0067,0x0072,0x0061,0x0064,0x0065,0x0072,0x0061,0x0020,0x0066,0x0069,0x0072,0x006D,0x0077,0x0061,0x0072,0x0065,0x003F,0x0000},//Vill du forts?tta att uppgradera firmware?
												{0x30D5,0x30A1,0x30FC,0x30E0,0x30A6,0x30A7,0x30A2,0x306E,0x30A2,0x30C3,0x30D7,0x30B0,0x30EC,0x30FC,0x30C9,0x3092,0x7D9A,0x884C,0x3057,0x307E,0x3059,0x304B,0x003F,0x0000},//ファームウェアのアップグレードを続行しますか?
												{0xD38C,0xC6E8,0xC5B4,0xB97C,0x0020,0xACC4,0xC18D,0x0020,0xC5C5,0xADF8,0xB808,0xC774,0xB4DC,0xD558,0xC2DC,0xACA0,0xC2B5,0xB2C8,0xAE4C,0x003F,0x0000},//???? ?? ????????????
												{0x041F,0x0440,0x043E,0x0434,0x043E,0x043B,0x0436,0x0430,0x0442,0x044C,0x0020,0x043E,0x0431,0x043D,0x043E,0x0432,0x043B,0x044F,0x0442,0x044C,0x0020,0x043F,0x0440,0x043E,0x0448,0x0438,0x0432,0x043A,0x0443,0x003F,0x0000},//Продолжать обновлять прошивку?
												{0x03A3,0x03C5,0x03BD,0x03AD,0x03C7,0x03B9,0x03C3,0x03B7,0x0020,0x03C4,0x03B7,0x03C2,0x0020,0x03B1,0x03BD,0x03B1,0x03B2,0x03AC,0x03B8,0x03BC,0x03B9,0x03C3,0x03B7,0x03C2,0x0020,0x03C4,0x03BF,0x03C5,0x0020,0x03C5,0x03BB,0x03B9,0x03BA,0x03BF,0x03BB,0x03BF,0x03B3,0x03B9,0x03C3,0x03BC,0x03B9,0x03BA,0x03BF,0x03CD,0x003B,0x0000},//Συν?χιση τη? αναβ?θμιση? του υλικολογισμικο?;
											#else
	...
	default:
		...
		case LANGUAGE_PT:
			...
			break;
		case LANGUAGE_PL:
			memcpy(tmpbuf1, &str_notify[global_settings.language][0], 2*25);
			memcpy(tmpbuf2, &str_notify[global_settings.language][25], 2*(mmi_ucs2strlen(str_notify[global_settings.language])-25));
			break;
		case LANGUAGE_SE:
			memcpy(tmpbuf1, &str_notify[global_settings.language][0], 2*22);
			memcpy(tmpbuf2, &str_notify[global_settings.language][22], 2*(mmi_ucs2strlen(str_notify[global_settings.language])-22));
			break;
		case LANGUAGE_JP:
			memcpy(tmpbuf1, &str_notify[global_settings.language][0], 2*13);
	...
	case FOTA_STATUS_LINKING:
		{
			uint16_t str_notify[LANGUAGE_MAX][28] = {
														...
														{0x004C,0x00E4,0x006E,0x006B,0x0061,0x0072,0x0020,0x0074,0x0069,0x006C,0x006C,0x0020,0x0073,0x0065,0x0072,0x0076,0x0065,0x0072,0x002E,0x002E,0x002E,0x0000},//L?nkar till server...
														{0x30B5,0x30FC,0x30D0,0x30FC,0x306B,0x30EA,0x30F3,0x30AF,0x3057,0x3066,0x3044,0x307E,0x3059,0x002E,0x002E,0x002E,0x0000},//サーバーにリンクしています...
														...
														{0x03A3,0x03CD,0x03BD,0x03B4,0x03B5,0x03C3,0x03B7,0x0020,0x03BC,0x03B5,0x0020,0x03B4,0x03B9,0x03B1,0x03BA,0x03BF,0x03BC,0x03B9,0x03C3,0x03C4,0x03AE,0x002E,0x002E,0x002E,0x0000},//Σ?νδεση με διακομιστ?...
													#else
	...
	case FOTA_STATUS_DOWNLOADING:
		if(!flag)
		{
			uint16_t str_notify[LANGUAGE_MAX][32] = {
														...
														{0x0044,0x0061,0x0074,0x0061,0x0020,0x006C,0x0061,0x0064,0x0064,0x0061,0x0073,0x0020,0x006E,0x0065,0x0064,0x002E,0x002E,0x002E,0x0000},//Data laddas ned...
														{0x30C7,0x30FC,0x30BF,0x3092,0x30C0,0x30A6,0x30F3,0x30ED,0x30FC,0x30C9,0x3057,0x3066,0x3044,0x307E,0x3059,0x002E,0x002E,0x002E,0x0000},//データをダウンロードしています...
														{0xB370,0xC774,0xD130,0xB97C,0x0020,0xB2E4,0xC6B4,0xB85C,0xB4DC,0xD558,0xB294,0x0020,0xC911,0x002E,0x002E,0x002E,0x0000},//???? ?????? ?...
														...
														{0x039B,0x03AE,0x03C8,0x03B7,0x0020,0x03B4,0x03B5,0x03B4,0x03BF,0x03BC,0x03AD,0x03BD,0x03C9,0x03BD,0x002E,0x002E,0x002E,0x0000},//Λ?ψη δεδομ?νων...
													#else
	...
	case FOTA_STATUS_FINISHED:
		{
			...
			uint16_t str_notify[LANGUAGE_MAX][26] = {
														...
														{0x0055,0x0070,0x0070,0x0067,0x0072,0x0061,0x0064,0x0065,0x0072,0x0069,0x006E,0x0067,0x0065,0x006E,0x0020,0x0073,0x006C,0x0075,0x0074,0x0066,0x00F6,0x0072,0x0064,0x0000},//Uppgraderingen slutf?rd
														{0x30A2,0x30C3,0x30D7,0x30B0,0x30EC,0x30FC,0x30C9,0x304C,0x5B8C,0x4E86,0x3057,0x307E,0x3057,0x305F,0x0000},//アップグレードが完了しました
														{0xC5C5,0xADF8,0xB808,0xC774,0xB4DC,0x0020,0xC644,0xB8CC,0x0000},//????? ??
														{0x041E,0x0431,0x043D,0x043E,0x0432,0x043B,0x0435,0x043D,0x0438,0x0435,0x0020,00437,0x0430,0x0432,0x0435,0x0440,0x0448,0x0435,0x043D,0x043E,0x0000},//Обновление завершено
														{0x0397,0x0020,0x03B1,0x03BD,0x03B1,0x03B2,0x03AC,0x03B8,0x03BC,0x03B9,0x03C3,0x03B7,0x0020,0x03BF,0x03BB,0x03BF,0x03BA,0x03BB,0x03B7,0x03C1,0x03CE,0x03B8,0x03B7,0x03BA,0x03B5,0x0000},//Η αναβ?θμιση ολοκληρ?θηκε
													#else
	...
	case FOTA_STATUS_ERROR:
		{
			uint16_t str_notify[LANGUAGE_MAX][30] = {
														...
														{0x0041,0x006B,0x0074,0x0075,0x0061,0x006C,0x0069,0x007A,0x0061,0x0063,0x006A,0x0061,0x0020,0x006E,0x0069,0x0065,0x0020,0x0070,0x006F,0x0077,0x0069,0x006F,0x0064,0x0142,0x0061,0x0020,0x0073,0x0069,0x0119,0x0000},//Aktualizacja nie powiod?a si?
														{0x0055,0x0070,0x0070,0x0067,0x0072,0x0061,0x0064,0x0065,0x0072,0x0069,0x006E,0x0067,0x0065,0x006E,0x0020,0x006D,0x0069,0x0073,0x0073,0x006C,0x0079,0x0063,0x006B,0x0061,0x0064,0x0065,0x0073,0x0000},//Uppgraderingen misslyckades
														{0x30A2,0x30C3,0x30D7,0x30B0,0x30EC,0x30FC,0x30C9,0x306B,0x5931,0x6557,0x3057,0x307E,0x3057,0x305F,0x0000},//アップグレードに失敗しました
														...
														{0x0397,0x0020,0x03B1,0x03BD,0x03B1,0x03B2,0x03AC,0x03B8,0x03BC,0x03B9,0x03C3,0x03B7,0x0020,0x03B1,0x03C0,0x03AD,0x03C4,0x03C5,0x03C7,0x03B5,0x0000},//Η αναβ?θμιση απ?τυχε
													#else
