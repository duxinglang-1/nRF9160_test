			...
			case RESET_STATUS_IDLE:
				{
					uint16_t str_ready[LANGUAGE_MAX][44] = {
															  ...
															  #endif
															  #ifdef LANGUAGE_DE_ENABLE
																{0x0041,0x0075,0x0066,0x0020,0x0057,0x0065,0x0072,0x006B,0x0073,0x0065,0x0069,0x006E,0x0073,0x0074,0x0065,0x006C,0x006C,0x0075,0x006E,0x0067,0x0020,0x007A,0x0075,0x0072,0x00FC,0x0063,0x006B,0x0073,0x0065,0x0074,0x007A,0x0065,0x006E,0x0000},//Auf Werkseinstellung zurücksetzen
															  #endif
															  #ifdef LANGUAGE_FR_ENABLE
																{0x0052,0x00E9,0x0069,0x006E,0x0069,0x0074,0x0069,0x0061,0x006C,0x0069,0x0073,0x0061,0x0074,0x0069,0x006F,0x006E,0x0020,0x0061,0x0075,0x0078,0x0020,0x0070,0x0061,0x0072,0x0061,0x006D,0x00E8,0x0074,0x0072,0x0065,0x0073,0x0020,0x0064,0x0027,0x0075,0x0073,0x0069,0x006E,0x0065,0x0000},//Réinitialisation aux paramètres d'usine
															  #endif
															  #ifdef LANGUAGE_IT_ENABLE
...
void SPO2ShowStatus(void)
{
	...
	uint16_t title_str[LANGUAGE_MAX][25] = {
											  ...
											  #endif
											  #ifdef LANGUAGE_FR_ENABLE
												{0x004F,0x0078,0x0079,0x0067,0x00E8,0x006E,0x0065,0x0020,0x0073,0x0061,0x006E,0x0067,0x0075,0x0069,0x006E,0x0065,0x0000},//Oxyg鑞e sanguine
											  #endif
											  #ifdef LANGUAGE_IT_ENABLE
