...
void SPO2ShowStatus(void)
{
	...
	uint16_t i,w,h;
	uint16_t title_str[LANGUAGE_MAX][35] = {
											#ifndef FW_FOR_CN
											  #ifdef LANGUAGE_EN_ENABLE
											  ...
											  #endif
											  #ifdef LANGUAGE_FR_ENABLE
												{0x0053,0x0061,0x0074,0x0075,0x0072,0x0061,0x0074,0x0069,0x006F,0x006E,0x0020,0x0065,0x006E,0x0020,0x006F,0x0078,0x0079,0x0067,0x00E8,0x006E,0x0065,0x0020,0x0064,0x0061,0x006E,0x0073,0x0020,0x006C,0x0065,0x0020,0x0073,0x0061,0x006E,0x0067,0x0000},//Saturation en oxygène dans le sang
											  #endif
											  #ifdef LANGUAGE_IT_ENABLE
