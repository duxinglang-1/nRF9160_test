...
uint16_t MAIN_SEL_STR[LANGUAGE_MAX][7][33] = 
{
	...
	},
	{
		...
		{0x0057,0x0079,0x015B,0x0077,0x0069,0x0065,0x0074,0x006C,0x0061,0x0063,0x007A,0x0020,0x0074,0x0065,0x006D,0x0070,0x0065,0x0072,0x0061,0x0074,0x0075,0x0072,0x0079,0x0000},//Wy?wietlacz temperatury
		{0x0049,0x006E,0x0066,0x006F,0x0072,0x006D,0x0061,0x0063,0x006A,0x0065,0x0020,0x006F,0x0020,0x0075,0x0072,0x007A,0x0105,0x0064,0x007A,0x0065,0x006E,0x0069,0x0075,0x0000},//Informacje o urz?dzeniu
		{0x004B,0x006F,0x0064,0x0020,0x0051,0x0052,0x0020,0x0043,0x0061,0x0072,0x0065,0x006D,0x0061,0x0074,0x0065,0x0000},//Kod QR Caremate
		{0x0044,0x006F,0x006D,0x0079,0x015B,0x006C,0x006E,0x0065,0x0020,0x0075,0x0073,0x0074,0x0061,0x0077,0x0069,0x0065,0x006E,0x0069,0x0061,0x0020,0x0066,0x0061,0x0062,0x0072,0x0079,0x0063,0x007A,0x006E,0x0065,0x0000},//Domy?lne ustawienia fabryczne
		{0x0041,0x006B,0x0074,0x0075,0x0061,0x006C,0x0069,0x007A,0x0061,0x0063,0x006A,0x0061,0x0020,0x004F,0x0054,0x0041,0x0000},//Aktualizacja OTA
	},
	{
		...
		{0x0054,0x0065,0x006D,0x0070,0x0020,0x0064,0x0069,0x0073,0x0070,0x006C,0x0061,0x0079,0x0000},//Temp display
		{0x0045,0x006E,0x0068,0x0065,0x0074,0x0073,0x0069,0x006E,0x0066,0x006F,0x0072,0x006D,0x0061,0x0074,0x0069,0x006F,0x006E,0x0000},//Enhetsinformation
		{0x0043,0x0061,0x0072,0x0065,0x006D,0x0061,0x0074,0x0065,0x0020,0x0051,0x0052,0x0000},//Caremate QR
		{0x0046,0x0061,0x0062,0x0072,0x0069,0x006B,0x0073,0x0069,0x006E,0x0073,0x0074,0x00E4,0x006C,0x006C,0x006E,0x0069,0x006E,0x0067,0x0000},//Fabriksinst?llning
		{0x004F,0x0054,0x0041,0x2013,0x0075,0x0070,0x0070,0x0064,0x0061,0x0074,0x0065,0x0072,0x0069,0x006E,0x0067,0x0000},//OTA-uppdatering
	},
	{
		{0x8A00,0x08A9E,0x0000},//言語
		{0x8F1D,0x5EA6,0x0000},//輝度
		{0x6E29,0x5EA6,0x8868,0x793A,0x0000},//温度表示
		{0x30C7,0x30D0,0x30A4,0x30B9,0x60C5,0x5831,0x0000},//デバイス情報
		{0x30B1,0x30A2,0x30E1,0x30A4,0x30C8,0x0051,0x0052,0x0000},//ケアメイトQR
		{0x5DE5,0x5834,0x51FA,0x8377,0x6642,0x306E,0x30C7,0x30D5,0x30A9,0x30EB,0x30C8,0x0000},//工場出荷時のデフォルト
		{0x004F,0x0054,0x0041,0x30A2,0x30C3,0x30D7,0x30C7,0x30FC,0x30C8,0x0000},//OTAアップデート
	},
	{
		{0xC5B8,0xC5B4,0x0000},//??
		{0xBA85,0xB3C4,0x0000},//??
		{0xCCB4,0xC628,0x0020,0xD45C,0xC2DC,0x0000},//?? ??
		{0xC7A5,0xCE58,0x0020,0xC815,0xBCF4,0x0000},//?? ??
		{0xCF00,0xC5B4,0xBA54,0xC774,0xD2B8,0x0020,0x0051,0x0052,0x0000},//????? QR
		{0xACF5,0xC7A5,0x0020,0xAE30,0xBCF8,0xAC12,0x0000},//?? ???
		{0x004F,0x0054,0x0041,0x0020,0xC5C5,0xB370,0xC774,0xD2B8,0x0000},//OTA ????
	},
	{
		{0x042F,0x0437,0x044B,0x043A,0x0000},//Язык
		{0x042F,0x0440,0x043A,0x043E,0x0441,0x0442,0x044C,0x0000},//Яркость
		{0x041E,0x0442,0x043E,0x0431,0x0440,0x0430,0x0436,0x0435,0x043D,0x0438,0x0435,0x0020,0x0442,0x0435,0x043C,0x043F,0x0435,0x0440,0x0430,0x0442,0x0443,0x0440,0x044B,0x0000},//Отображение температуры
		{0x0418,0x043D,0x0444,0x043E,0x0440,0x043C,0x0430,0x0446,0x0438,0x044F,0x0020,0x043E,0x0431,0x0020,0x0443,0x0441,0x0442,0x0440,0x043E,0x0439,0x0441,0x0442,0x0432,0x0435,0x0000},//Информация об устройстве
		{0x041A,0x0430,0x0440,0x0435,0x043C,0x0430,0x0442,0x0020,0x0051,0x0052,0x0000},//Каремат QR
		{0x0417,0x0430,0x0432,0x043E,0x0434,0x0441,0x043A,0x0438,0x0435,0x0020,0x043D,0x0430,0x0441,0x0442,0x0440,0x043E,0x0439,0x043A,0x0438,0x0020,0x043F,0x043E,0x0020,0x0443,0x043C,0x043E,0x043B,0x0447,0x0430,0x043D,0x0438,0x044E,0x0000},//Заводские настройки по умолчанию
		{0x041E,0x0431,0x043D,0x043E,0x0432,0x043B,0x0435,0x043D,0x0438,0x0435,0x0020,0x004F,0x0054,0x0041,0x0000},//Обновление OTA
	},
	{
		{0x0393,0x03BB,0x03CE,0x03C3,0x03C3,0x03B1,0x0000},//Γλ?σσα
		{0x039B,0x03AC,0x03BC,0x03C8,0x03B7,0x0000},//Λ?μψη
		{0x0388,0x03BD,0x03B4,0x03B5,0x03B9,0x03BE,0x03B7,0x0020,0x03B8,0x03B5,0x03C1,0x03BC,0x03BF,0x03BA,0x03C1,0x03B1,0x03C3,0x03AF,0x03B1,0x03C2,0x0000},//?νδειξη θερμοκρασ?α?
		{0x03A0,0x03BB,0x03B7,0x03C1,0x03BF,0x03C6,0x03BF,0x03C1,0x03AF,0x03B5,0x03C2,0x0020,0x03C3,0x03C5,0x03C3,0x03BA,0x03B5,0x03C5,0x03AE,0x03C2,0x0000},//Πληροφορ?ε? συσκευ??
		{0x0043,0x0061,0x0072,0x0065,0x006D,0x0061,0x0074,0x0065,0x0020,0x0051,0x0052,0x0000},//Caremate QR
		{0x0395,0x03C1,0x03B3,0x03BF,0x03C3,0x03C4,0x03B1,0x03C3,0x03B9,0x03B1,0x03BA,0x03AE,0x0020,0x03C0,0x03C1,0x03BF,0x03B5,0x03C0,0x03B9,0x03BB,0x03BF,0x03B3,0x03AE,0x0000},//Εργοστασιακ? προεπιλογ?
		{0x0395,0x03BD,0x03B7,0x03BC,0x03AD,0x03C1,0x03C9,0x03C3,0x03B7,0x0020,0x004F,0x0054,0x0041,0x0000},//Ενημ?ρωση OTA
	},
#else
	{
...
const settings_menu_t SETTING_MAIN_MENU = 
{
	...
	7,
	{
		...
		},
		{
			...
			MAIN_SEL_STR[4][4],//Ajustes de fábrica
		...
		},
		{
			...
			MAIN_SEL_STR[6][2],//Wy?wietlacz temperatury
			MAIN_SEL_STR[6][3],//Informacje o urz?dzeniu
			MAIN_SEL_STR[6][4],//Kod QR Caremate
			MAIN_SEL_STR[6][5],//Domy?lne ustawienia fabryczne
			MAIN_SEL_STR[6][6],//Aktualizacja OTA
		},
		{
		...
		},
		{
			MAIN_SEL_STR[8][0],//言語
			MAIN_SEL_STR[8][1],//輝度
			MAIN_SEL_STR[8][2],//温度表示
			MAIN_SEL_STR[8][3],//デバイス情報
			MAIN_SEL_STR[8][4],//ケアメイトQR
			MAIN_SEL_STR[8][5],//工場出荷時のデフォルト
			MAIN_SEL_STR[8][6],//OTAアップデート
		},
		{
			MAIN_SEL_STR[9][0],//??
			MAIN_SEL_STR[9][1],//??
		...
		{
			MAIN_SEL_STR[11][0],//Γλ?σσα
			MAIN_SEL_STR[11][1],//Λ?μψη
			MAIN_SEL_STR[11][2],//?νδειξη θερμοκρασ?α?
			MAIN_SEL_STR[11][3],//Πληροφορ?ε? συσκευ??
			MAIN_SEL_STR[11][4],//Caremate QR
			MAIN_SEL_STR[11][5],//Εργοστασιακ? προεπιλογ?
			MAIN_SEL_STR[11][6],//Ενημ?ρωση OTA
		},
	#else
		{
			MAIN_SEL_STR[0][0],//语言
...
uint16_t TEMP_SEL_STR[LANGUAGE_MAX][2][20] = 
{
	...
	{
		{0x0043,0x0065,0x006C,0x0073,0x006A,0x0075,0x0073,0x007A,0x0000},//Celsjusz
		{0x0046,0x0061,0x0068,0x0072,0x0065,0x006E,0x0068,0x0065,0x0069,0x0074,0x0000},//Fahrenheit
	},
	{
		{0x0043,0x0065,0x006C,0x0073,0x0069,0x0075,0x0073,0x0000},//Celsius
	...
	{
		{0x6442,0x6C0F,0x0000},//摂氏
		{0x83EF,0x6C0F,0x0000},//華氏
	},
	{
	...
	{
		{0x0426,0x0435,0x043B,0x044C,0x0441,0x0438,0x044F,0x0000},//Цельсия
		{0x043F,0x043E,0x0020,0x0424,0x0430,0x0440,0x0435,0x043D,0x0433,0x0435,0x0439,0x0442,0x0443,0x0000},//по Фаренгейту
	},
	{
		{0x039A,0x03B5,0x03BB,0x03C3,0x03AF,0x03BF,0x03C5,0x0000},//Κελσ?ου
		{0x03B8,0x03B5,0x03C1,0x03BC,0x03CC,0x03BC,0x03B5,0x03C4,0x03C1,0x03BF,0x0020,0x03A6,0x03B1,0x03C1,0x03B5,0x03BD,0x03AC,0x03B9,0x03C4,0x0000},//θερμ?μετρο Φαρεν?ιτ
	},
#else
	{
