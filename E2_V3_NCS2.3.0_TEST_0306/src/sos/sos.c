...
void SOSRecLocatNotify(uint8_t *strmsg)
{
	uint16_t strtitle[LANGUAGE_MAX][2][40] = {
												...
												},
												{
													...
													{0x062A,0x0645,0x0020,0x0646,0x0634,0x0631,0x0020,0x0645,0x0648,0x0642,0x0639,0x0020,0x0053,0x004F,0x0053,0x0020,0x0628,0x0627,0x0644,0x0642,0x0631,0x0628,0x0020,0x0645,0x0646,0x0020,0x0022,0x0000},
