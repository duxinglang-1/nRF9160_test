...
void SOSRecLocatNotify(uint8_t *strmsg)
{
	uint16_t strtitle[LANGUAGE_MAX][2][35] = {
												...
												{
													//SOS-Standort in der N?he von "xxxxxxxxxxxxxx" auf CareMate gepostet.
												...
												{
													//Localiza??o do SOS Perto de "XXXXXXXXXXXXX" publicada no CareMate.
												...
												{
													//Lokalizacja SOS w pobli?u 'XXXXXXXXXXXXX' opublikowana na CareMate.
													{0x004C,0x006F,0x006B,0x0061,0x006C,0x0069,0x007A,0x0061,0x0063,0x006A,0x0061,0x0020,0x0053,0x004F,0x0053,0x0020,0x0077,0x0020,0x0070,0x006F,0x0062,0x006C,0x0069,0x017C,0x0075,0x0020,0x0027,0x0000},
												...
												{
													//SOS-position n?ra 'XXXXXXXXXXXXX' har skickats till CareMate.
													{0x0053,0x004F,0x0053,0x2013,0x0070,0x006F,0x0073,0x0069,0x0074,0x0069,0x006F,0x006E,0x0020,0x006E,0x00E4,0x0072,0x0061,0x0020,0x0027,0x0000},
												...
												{
													//「XXXXXXXXXXX」付近のSOSアドレスがCareMateに送信されました。
													{0x300C,0x0000},
													{0x300D,0x4ED8,0x8FD1,0x306E,0x0053,0x004F,0x0053,0x30A2,0x30C9,0x30EC,0x30B9,0x304C,0x0043,0x0061,0x0072,0x0065,0x004D,0x0061,0x0074,0x0065,0x306B,0x9001,0x4FE1,0x3055,0x308C,0x307E,0x3057,0x305F,0x3002,0x0000},
												},
											  #endif
											  #ifdef LANGUAGE_KR_ENABLE
												{
													//「XXXXXXXXXXX」??? SOS ??? CareMate? ???????.
													{0x300C,0x0000},
													{0x300D,0xADFC,0xCC98,0xC758,0x0020,0x0053,0x004F,0x0053,0x0020,0xC54C,0xB9BC,0xC774,0x0020,0x0043,0x0061,0x0072,0x0065,0x004D,0x0061,0x0074,0x0065,0xC5D0,0x0020,0xC804,0xC1A1,0xB418,0xC5C8,0xC2B5,0xB2C8,0xB2E4,0x002E,0x0000},
												},
											  #endif
											  #ifdef LANGUAGE_RU_ENABLE
												{
													//Оповещение о SOS рядом с 'XXXXXXXXXXX' отправлено в CareMate.
													{0x041E,0x043F,0x043E,0x0432,0x0435,0x0449,0x0435,0x043D,0x0438,0x0435,0x0020,0x043E,0x0020,0x0053,0x004F,0x0053,0x0020,0x0440,0x044F,0x0434,0x043E,0x043C,0x0020,0x0441,0x0020,0x0027,0x0000},
