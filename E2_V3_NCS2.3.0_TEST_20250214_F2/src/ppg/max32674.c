...
static uint16_t str_timing_note[LANGUAGE_MAX][90] = {
														...
														{0x3053,0x308C,0x304B,0x3089,0x30BF,0x30A4,0x30DF,0x30F3,0x30B0,0x8A08,0x6E2C,0x304C,0x59CB,0x307E,0x308A,0x3001,0x4ECA,0x56DE,0x306E,0x8A08,0x6E2C,0x306F,0x7D42,0x4E86,0x3067,0x3059,0xFF01,0x0000},//これからタイミング計測が始まり、今回の計測は終了です！
													  #endif
...
static uint16_t str_running_note[LANGUAGE_MAX][70] = {
													  ...
													  #endif
													  #ifdef LANGUAGE_JP_ENABLE
														{0x30BB,0x30F3,0x30B5,0x30FC,0x306F,0x52D5,0x4F5C,0x4E2D,0x3067,0x3059,0x3002,0x3057,0x3070,0x3089,0x304F,0x3057,0x3066,0x304B,0x3089,0x3082,0x3046,0x4E00,0x5EA6,0x304A,0x8A66,0x3057,0x304F,0x3060,0x3055,0x3044,0x3002,0x0000},//センサーは動作中です。しばらくしてからもう一度お試しください。
													  #endif
													  #ifdef LANGUAGE_KR_ENABLE
													  ...
													  #endif
													  #ifdef LANGUAGE_RU_ENABLE
														{0x0414,0x0430,0x0442,0x0447,0x0438,0x043A,0x0020,0x0440,0x0430,0x0431,0x043E,0x0442,0x0430,0x0435,0x0442,0x002C,0x0020,0x043F,0x043E,0x043F,0x0440,0x043E,0x0431,0x0443,0x0439,0x0442,0x0435,0x0020,0x0435,0x0449,0x0435,0x0020,0x0440,0x0430,0x0437,0x0020,0x043F,0x043E,0x0437,0x0436,0x0435,0x0021,0x0000},//Датчик работает, попробуйте еще раз позже!
													  #endif
													  #ifdef LANGUAGE_AR_ENABLE
