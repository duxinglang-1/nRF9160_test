...
//img data
#define IMG_DATA_ADDR						(IMG_START_ADDR+SPIFlash_SECTOR_SIZE)
//analog clock(6)
...
#define FONT_DATA_ADDR						(FONT_START_ADDR+SPIFlash_SECTOR_SIZE)
...
#define PPG_ALGO_FW_ADDR					(PPG_ALGO_START_ADDR+SPIFlash_SECTOR_SIZE)
