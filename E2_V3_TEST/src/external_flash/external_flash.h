...
#define IMG_TEMP_BIG_ICON_C_1_ADDR			(IMG_TEMP_ICON_C_END)
#define IMG_TEMP_BIG_ICON_C_1_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_C_1_END			(IMG_TEMP_BIG_ICON_C_1_ADDR+IMG_TEMP_BIG_ICON_C_1_SIZE)
#define IMG_TEMP_BIG_ICON_C_2_ADDR			(IMG_TEMP_BIG_ICON_C_1_END)
#define IMG_TEMP_BIG_ICON_C_2_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_C_2_END			(IMG_TEMP_BIG_ICON_C_2_ADDR+IMG_TEMP_BIG_ICON_C_2_SIZE)
#define IMG_TEMP_BIG_ICON_C_3_ADDR			(IMG_TEMP_BIG_ICON_C_2_END)
#define IMG_TEMP_BIG_ICON_C_3_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_C_3_END			(IMG_TEMP_BIG_ICON_C_3_ADDR+IMG_TEMP_BIG_ICON_C_3_SIZE)
#define IMG_TEMP_ICON_F_ADDR				(IMG_TEMP_BIG_ICON_C_3_END)
#define IMG_TEMP_ICON_F_SIZE				(2864)
#define IMG_TEMP_ICON_F_END					(IMG_TEMP_ICON_F_ADDR+IMG_TEMP_ICON_F_SIZE)
#define IMG_TEMP_BIG_ICON_F_1_ADDR			(IMG_TEMP_ICON_F_END)
#define IMG_TEMP_BIG_ICON_F_1_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_F_1_END			(IMG_TEMP_BIG_ICON_F_1_ADDR+IMG_TEMP_BIG_ICON_F_1_SIZE)
#define IMG_TEMP_BIG_ICON_F_2_ADDR			(IMG_TEMP_BIG_ICON_F_1_END)
#define IMG_TEMP_BIG_ICON_F_2_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_F_2_END			(IMG_TEMP_BIG_ICON_F_2_ADDR+IMG_TEMP_BIG_ICON_F_2_SIZE)
#define IMG_TEMP_BIG_ICON_F_3_ADDR			(IMG_TEMP_BIG_ICON_F_2_END)
#define IMG_TEMP_BIG_ICON_F_3_SIZE			(5888)
#define IMG_TEMP_BIG_ICON_F_3_END			(IMG_TEMP_BIG_ICON_F_3_ADDR+IMG_TEMP_BIG_ICON_F_3_SIZE)
#define IMG_TEMP_UNIT_C_ADDR				(IMG_TEMP_BIG_ICON_F_3_END)
