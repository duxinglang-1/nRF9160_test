...
/** @addtogroup  Interfaces_Functions
  ...
  *
**/
typedef int32_t (*maxdev_write_ptr)(struct device *handle, uint8_t *bufp, uint16_t len);
typedef int32_t (*maxdev_read_ptr)(struct device *handle, uint8_t *bufp, uint16_t len);

typedef struct {
  /** Component mandatory fields **/
  maxdev_write_ptr  write;
  maxdev_read_ptr   read;
