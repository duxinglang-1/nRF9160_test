...
#define GBLUE			 0xFFFF00	//蓝绿色
#define RED           	 0x0000FF	//红色
#define MAGENTA       	 0xFF00FF	//玫瑰红
#define GREEN         	 0x00FF00	//绿色
#define CYAN          	 0xEFFFFF	//青色
#define YELLOW        	 0xFFFF00	//黄色
#define BROWN 			 0xBFB800 	//棕色
#define BRRED 			 0xFF883A 	//棕红色
#define GRAY  			 0x808480 	//灰色
#define DARKBLUE      	 0x003878	//深蓝色
#define LIGHTBLUE      	 0x78ACE0	//浅蓝色  
#define GRAYBLUE       	 0x50ACC0 	//灰蓝色
#define LIGHTGREEN     	 0x8080F8 	//浅绿色
#define LIGHTGRAY        0xE8E8D8 	//浅灰色(PANNEL)
