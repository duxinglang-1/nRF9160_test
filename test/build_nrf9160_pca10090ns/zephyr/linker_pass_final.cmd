...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0xc000, LENGTH = 0xf4000
    SRAM (wx) : ORIGIN = 0x20020000, LENGTH = (128 * 1K)
    IDT_LIST (wx) : ORIGIN = (0x20020000 + (128 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(.ARM.exidx* gnu.linkonce.armexidx.*)
 ...
 net_socket_register :
 {
  ...
  KEEP(*(SORT("._net_socket_register.*")))
 ...
 *(".kernel.*")
  ...
  *(".net_l2.data")
  ...
  __net_l2_data_end = .;
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20020000 + (128 * 1K);
