...
#define FONT_RM_JIS_16_SIZE		(343792)
#define FONT_RM_JIS_16_END		(FONT_RM_JIS_16_ADDR+FONT_RM_JIS_16_SIZE)

#define FONT_RM_GBK_16_ADDR		(FONT_RM_JIS_16_END+FONT_OFFSET)
#define FONT_RM_GBK_16_SIZE		(261104)
#define FONT_RM_GBK_16_END		(FONT_RM_GBK_16_ADDR+FONT_RM_GBK_16_SIZE)
