...
#define FOTA_NOTIFY_RECT_W		180
#define FOTA_NOTIFY_RECT_H		130
...
#define	FOTA_NOTIFY_STRING_Y	(FOTA_NOTIFY_RECT_Y+20)
...
#define FOTA_NOTIFY_YES_H		20
#define FOTA_NOTIFY_YES_X		(FOTA_NOTIFY_RECT_X+10)
#define FOTA_NOTIFY_YES_Y		160

#define FOTA_NOTIFY_NO_W		60
#define FOTA_NOTIFY_NO_H		20
#define FOTA_NOTIFY_NO_X		(FOTA_NOTIFY_RECT_X+(FOTA_NOTIFY_RECT_W-FOTA_NOTIFY_NO_W-10))
#define FOTA_NOTIFY_NO_Y		160


#define FOTA_NOTIFY_OFFSET_W	4
#define FOTA_NOTIFY_OFFSET_H	4
...
extern void ExitFotaScreen(void);
